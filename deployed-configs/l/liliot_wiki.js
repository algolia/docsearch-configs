new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://wiki.loliot.net/docs/",
    "https://wiki.loliot.net/",
    "https://wiki.loliot.net/docs/lang/cpp/libraries/cpp-stl",
  ],
  renderJavaScript: false,
  sitemaps: ["https://wiki.loliot.net/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://wiki.loliot.net/**"],
