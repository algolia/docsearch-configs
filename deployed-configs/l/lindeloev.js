new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://lindeloev.github.io/job/index.html",
    "https://lindeloev.github.io/",
    "https://lindeloev.github.io/job/reference",
    "https://lindeloev.github.io/job/articles",
  ],
  ...
  actions: [
    {
      indexName: "lindeloev",
      pathsToMatch: ["https://lindeloev.github.io/job/index.html**/**"],
    ...
    {
      indexName: "lindeloev",
      pathsToMatch: ["https://lindeloev.github.io/job/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "lindeloev",
      pathsToMatch: ["https://lindeloev.github.io/job/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
