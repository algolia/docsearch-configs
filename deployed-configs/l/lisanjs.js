new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://lisanjs.com/docs/", "https://lisanjs.com/"],
  renderJavaScript: false,
  sitemaps: ["https://lisanjs.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://lisanjs.com/**"],
  schedule: "at 05:10 on Thursday",
  actions: [
    {
      indexName: "lisanjs",
      pathsToMatch: ["https://lisanjs.com/docs/**"],
