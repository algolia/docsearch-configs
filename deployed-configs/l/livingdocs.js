new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://docs.livingdocs.io/"],
  renderJavaScript: false,
  sitemaps: ["https://docs.livingdocs.io/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.livingdocs.io/**"],
  schedule: "at 05:10 on Thursday",
  actions: [
    {
      indexName: "livingdocs",
      pathsToMatch: ["https://docs.livingdocs.io**/**"],
