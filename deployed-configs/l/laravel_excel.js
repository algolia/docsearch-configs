new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://docs.laravel-excel.com/2.1/",
    "https://docs.laravel-excel.com/",
    "https://docs.laravel-excel.com/3.0/",
    "https://docs.laravel-excel.com/3.1/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.laravel-excel.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.laravel-excel.com/**"],
  schedule: "at 05:00 on Thursday",
  actions: [
    {
      indexName: "laravel_excel",
      pathsToMatch: ["https://docs.laravel-excel.com/2.1/**"],
    ...
    {
      indexName: "laravel_excel",
      pathsToMatch: ["https://docs.laravel-excel.com/3.0/**"],
      recordExtractor: ({ $, helpers }) => {
        return helpers.docsearch({
          recordProps: {
            lvl1: ".content__default h1",
    ...
    {
      indexName: "laravel_excel",
      pathsToMatch: ["https://docs.laravel-excel.com/3.1/**"],
      recordExtractor: ({ $, helpers }) => {
        return helpers.docsearch({
          recordProps: {
            lvl1: ".content__default h1",
