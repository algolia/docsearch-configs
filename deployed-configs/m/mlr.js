new Crawler({
  ...
  startUrls: [
    ...
    "https://mlr.mlr-org.com/reference",
    "https://mlr.mlr-org.com/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://mlr.mlr-org.com/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  discoveryPatterns: ["https://mlr.mlr-org.com/**"],
  schedule: "at 10:20 on Thursday",
  actions: [
    {
      indexName: "mlr",
      pathsToMatch: ["https://mlr.mlr-org.com/index.html**/**"],
    ...
    {
      indexName: "mlr",
      pathsToMatch: ["https://mlr.mlr-org.com/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "mlr",
      pathsToMatch: ["https://mlr.mlr-org.com/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
