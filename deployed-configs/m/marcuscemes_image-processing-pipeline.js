new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://ipp.vercel.app/docs/", "https://ipp.vercel.app/"],
  renderJavaScript: false,
  sitemaps: ["https://ipp.vercel.app/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://ipp.vercel.app/**"],
  schedule: "at 10:00 on Thursday",
  actions: [
    {
      indexName: "marcuscemes_image-processing-pipeline",
      pathsToMatch: ["https://ipp.vercel.app/docs/**"],
  ...
  initialIndexSettings: {
    "marcuscemes_image-processing-pipeline": {
