new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://next-with.moxy.tech/docs/",
    "https://next-with.moxy.tech/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://next-with.moxy.tech/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://next-with.moxy.tech/**"],
  schedule: "at 10:30 on Thursday",
  actions: [
    {
      indexName: "moxy_nextjs",
      pathsToMatch: ["https://next-with.moxy.tech/docs/**"],
