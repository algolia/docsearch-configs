new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://mobx-state-tree.js.org/"],
  renderJavaScript: false,
  sitemaps: ["https://mobx-state-tree.js.org/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://mobx-state-tree.js.org/**"],
  schedule: "at 10:30 on Thursday",
  actions: [
    {
      indexName: "mobx-state-tree",
      pathsToMatch: ["https://mobx-state-tree.js.org/**"],
