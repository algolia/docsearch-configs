new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://resources.mdzkm.wtf/"],
  renderJavaScript: false,
  sitemaps: ["https://resources.mdzkm.wtf/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://resources.mdzkm.wtf/**"],
  schedule: "at 10:00 on Thursday",
  actions: [
    {
      indexName: "mdzkm",
      pathsToMatch: ["https://resources.mdzkm.wtf/**"],
