new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://crono.matchplat.io/docs/",
    "https://crono.matchplat.io/",
    "https://crono.matchplat.io/docs/installation/installation",
  ],
  renderJavaScript: false,
  sitemaps: ["https://crono.matchplat.io/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://crono.matchplat.io/**"],
  schedule: "at 10:00 on Thursday",
  actions: [
    {
      indexName: "matchplat_crono",
      pathsToMatch: [
        "https://crono.matchplat.io/docs/**",
        "https://crono.matchplat.io/docs/installation/installation**/**",
      ],
