new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "http://hd.magnolia-cms.com/docs/",
    "http://hd.magnolia-cms.com/",
  ],
  renderJavaScript: false,
  sitemaps: ["http://hd.magnolia-cms.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["http://hd.magnolia-cms.com/**"],
  schedule: "at 10:00 on Thursday",
  actions: [
    {
      indexName: "magnolia-cms_hd",
      pathsToMatch: ["http://hd.magnolia-cms.com/docs/**"],
