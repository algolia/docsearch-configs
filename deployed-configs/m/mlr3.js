new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://mlr3.mlr-org.com/index.html",
    "https://mlr3.mlr-org.com/",
    "https://mlr3.mlr-org.com/reference",
    "https://mlr3.mlr-org.com/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://mlr3.mlr-org.com/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  discoveryPatterns: ["https://mlr3.mlr-org.com/**"],
  schedule: "at 10:20 on Thursday",
  actions: [
    {
      indexName: "mlr3",
      pathsToMatch: ["https://mlr3.mlr-org.com/index.html**/**"],
    ...
    {
      indexName: "mlr3",
      pathsToMatch: ["https://mlr3.mlr-org.com/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "mlr3",
      pathsToMatch: ["https://mlr3.mlr-org.com/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
