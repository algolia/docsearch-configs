new Crawler({
  ...
  startUrls: [
    ...
    "https://hubs.mozilla.com/blog/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://hubs.mozilla.com/sitemap.xml"],
  exclusionPatterns: [
    "**/help**",
    "**/help**/**",
    "**/users**",
  ...
  discoveryPatterns: ["https://hubs.mozilla.com/**"],
  schedule: "at 10:30 on Thursday",
  actions: [
    {
      indexName: "mozilla_hub",
      pathsToMatch: ["https://hubs.mozilla.com/docs/**"],
    ...
    {
      indexName: "mozilla_hub",
      pathsToMatch: ["https://hubs.mozilla.com/blog/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".hash-link";
        $(toRemove).remove();
