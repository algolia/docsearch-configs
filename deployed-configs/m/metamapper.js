new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://www.metamapper.io/docs/", "https://www.metamapper.io/"],
  renderJavaScript: false,
  sitemaps: ["https://www.metamapper.io/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://www.metamapper.io/**"],
  schedule: "at 10:00 on Thursday",
  actions: [
    {
      indexName: "metamapper",
      pathsToMatch: ["https://www.metamapper.io/docs/**"],
