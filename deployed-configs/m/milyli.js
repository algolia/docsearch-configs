new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://support.milyli.com/"],
  renderJavaScript: false,
  sitemaps: ["https://support.milyli.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://support.milyli.com/**"],
  schedule: "at 10:10 on Thursday",
  actions: [
    {
      indexName: "milyli",
      pathsToMatch: ["https://support.milyli.com/**"],
