new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://xjz3103.now.sh/docs/", "https://xjz3103.now.sh/"],
  renderJavaScript: false,
  sitemaps: ["https://xjz3103.now.sh/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://xjz3103.now.sh/**"],
  schedule: "at 14:20 on Saturday",
  actions: [
    {
      indexName: "xjz3103",
      pathsToMatch: ["https://xjz3103.now.sh/docs/**"],
