new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://xstate.js.org/docs", "https://xstate.js.org/"],
  renderJavaScript: false,
  sitemaps: [],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://xstate.js.org/**"],
  schedule: "at 14:40 on Saturday",
  actions: [
    {
      indexName: "xstatejs",
      pathsToMatch: ["https://xstate.js.org/docs**/**"],
