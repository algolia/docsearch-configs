new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "http://jeyser-crm.n7consulting.fr/docs/",
  ...
  discoveryPatterns: ["http://jeyser-crm.n7consulting.fr/**"],
  schedule: "at 20:00 on Wednesday",
  actions: [
    {
      indexName: "jeyser_crm",
      pathsToMatch: ["http://jeyser-crm.n7consulting.fr/docs/**"],
