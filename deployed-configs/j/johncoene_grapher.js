new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://grapher.network/docs/", "https://grapher.network/"],
  renderJavaScript: false,
  sitemaps: ["https://grapher.network/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://grapher.network/**"],
  schedule: "at 20:30 on Wednesday",
  actions: [
    {
      indexName: "johncoene_grapher",
      pathsToMatch: ["https://grapher.network/docs/**"],
