new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://react-isomorphic-data.netlify.app/docs/",
    "https://react-isomorphic-data.netlify.app/",
    "https://react-isomorphic-data.netlify.app/docs/intro",
  ],
  renderJavaScript: false,
  sitemaps: ["https://react-isomorphic-data.netlify.app/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://react-isomorphic-data.netlify.app/**"],
