new Crawler({
  ...
  discoveryPatterns: ["https://gwa.relayr.io/docs/**"],
  schedule: "at 10:00 on Friday",
  actions: [
    {
      indexName: "relayr_gwa",
      pathsToMatch: ["https://gwa.relayr.io/docs/**"],
      recordExtractor: ({ $, helpers }) => {
        ...
        return helpers.docsearch({
          recordProps: {
            lvl1: ".post h1",
            content:
              ".post article p, .post article li, .post article :nth-child(2)",
            lvl0: {
            ...
            lvl3: ".post h3",
            lvl4: ".post h4",
            lvl5: ".post h5, .post td:first-child",
          },
          indexHeadings: true,
        });
      },
