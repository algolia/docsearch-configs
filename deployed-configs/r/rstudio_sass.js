new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://rstudio.github.io/sass//index.html",
    "https://rstudio.github.io/",
    "https://rstudio.github.io/sass//reference",
    "https://rstudio.github.io/sass//articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://rstudio.github.io/sass//sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      ...
      pathsToMatch: ["https://rstudio.github.io/sass//index.html**/**"],
    ...
    {
      indexName: "rstudio_sass",
      pathsToMatch: ["https://rstudio.github.io/sass//reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "rstudio_sass",
      pathsToMatch: ["https://rstudio.github.io/sass//articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
