new Crawler({
  ...
  startUrls: [
    ...
    "https://docs.ropensci.org/stplanr/reference",
    "https://docs.ropensci.org/stplanr/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.ropensci.org/stplanr/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      indexName: "ropensci-stplanr",
      pathsToMatch: ["https://docs.ropensci.org/stplanr/index.html**/**"],
    ...
    {
      indexName: "ropensci-stplanr",
      pathsToMatch: ["https://docs.ropensci.org/stplanr/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "ropensci-stplanr",
      pathsToMatch: ["https://docs.ropensci.org/stplanr/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
