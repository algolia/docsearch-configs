new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://reactlab.dev/docs/", "https://reactlab.dev/"],
  renderJavaScript: false,
  sitemaps: ["https://reactlab.dev/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://reactlab.dev/**"],
  schedule: "at 10:00 on Friday",
  actions: [
    {
      indexName: "reactlab-dev",
      pathsToMatch: ["https://reactlab.dev/docs/**"],
