new Crawler({
  ...
  startUrls: [
    ...
    "https://docs.ropensci.org/textreuse/reference",
    "https://docs.ropensci.org/textreuse/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.ropensci.org/textreuse/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      indexName: "ropensci-textreuse",
      pathsToMatch: ["https://docs.ropensci.org/textreuse/index.html**/**"],
    ...
    {
      indexName: "ropensci-textreuse",
      pathsToMatch: ["https://docs.ropensci.org/textreuse/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "ropensci-textreuse",
      pathsToMatch: ["https://docs.ropensci.org/textreuse/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
