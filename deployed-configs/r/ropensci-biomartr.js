new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://docs.ropensci.org/biomartr/index.html",
    "https://docs.ropensci.org/",
    "https://docs.ropensci.org/biomartr/reference",
    "https://docs.ropensci.org/biomartr/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.ropensci.org/biomartr/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      indexName: "ropensci-biomartr",
      pathsToMatch: ["https://docs.ropensci.org/biomartr/index.html**/**"],
    ...
    {
      indexName: "ropensci-biomartr",
      pathsToMatch: ["https://docs.ropensci.org/biomartr/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "ropensci-biomartr",
      pathsToMatch: ["https://docs.ropensci.org/biomartr/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
