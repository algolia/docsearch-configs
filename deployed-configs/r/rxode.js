new Crawler({
  ...
  startUrls: [
    ...
    "https://nlmixrdevelopment.github.io/RxODE/reference",
    "https://nlmixrdevelopment.github.io/RxODE/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://nlmixrdevelopment.github.io/RxODE/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  discoveryPatterns: ["https://nlmixrdevelopment.github.io/**"],
  schedule: "at 10:50 on Friday",
  actions: [
    {
      indexName: "rxode",
      pathsToMatch: [
    ...
    {
      indexName: "rxode",
      pathsToMatch: ["https://nlmixrdevelopment.github.io/RxODE/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
