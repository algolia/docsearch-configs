new Crawler({
  ...
  startUrls: [
    ...
    "https://kyriosdata.github.io/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://kyriosdata.github.io/rnds/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://kyriosdata.github.io/**"],
  schedule: "at 10:30 on Friday",
  actions: [
    {
      indexName: "rnds",
      pathsToMatch: ["https://kyriosdata.github.io/rnds/**"],
