new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://reflexjs.org/docs/", "https://reflexjs.org/"],
  renderJavaScript: false,
  sitemaps: ["https://reflexjs.org/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://reflexjs.org/**"],
  schedule: "at 10:00 on Friday",
  actions: [
    {
      indexName: "reflexjs",
      pathsToMatch: ["https://reflexjs.org/docs/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = "main style";
        $(toRemove).remove();
