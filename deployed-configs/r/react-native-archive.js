new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://archive.reactnative.dev/"],
  renderJavaScript: false,
  sitemaps: ["https://archive.reactnative.dev/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://archive.reactnative.dev/**"],
  schedule: "at 10:00 on Friday",
  actions: [
    {
      indexName: "react-native-archive",
      pathsToMatch: ["https://archive.reactnative.dev/**"],
