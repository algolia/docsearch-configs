new Crawler({
  ...
  startUrls: [
    ...
    "https://rstudio.github.io/bootstraplib/reference",
    "https://rstudio.github.io/bootstraplib/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://rstudio.github.io/bootstraplib/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      ...
      pathsToMatch: ["https://rstudio.github.io/bootstraplib/index.html**/**"],
    ...
    {
      indexName: "rstudio_bootstraplib",
      pathsToMatch: ["https://rstudio.github.io/bootstraplib/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "rstudio_bootstraplib",
      pathsToMatch: ["https://rstudio.github.io/bootstraplib/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
