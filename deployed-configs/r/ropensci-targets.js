new Crawler({
  ...
  startUrls: [
    ...
    "https://docs.ropensci.org/targets/reference",
    "https://docs.ropensci.org/targets/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.ropensci.org/targets/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      indexName: "ropensci-targets",
      pathsToMatch: ["https://docs.ropensci.org/targets/index.html**/**"],
    ...
    {
      indexName: "ropensci-targets",
      pathsToMatch: ["https://docs.ropensci.org/targets/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "ropensci-targets",
      pathsToMatch: ["https://docs.ropensci.org/targets/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
