new Crawler({
  ...
  startUrls: [
    ...
    "https://rstudio.github.io/promises/reference",
    "https://rstudio.github.io/promises/articles",
  ],
  ...
  actions: [
    {
      indexName: "rstudio",
      pathsToMatch: ["https://rstudio.github.io/promises/index.html**/**"],
    ...
    {
      indexName: "rstudio",
      pathsToMatch: ["https://rstudio.github.io/promises/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "rstudio",
      pathsToMatch: ["https://rstudio.github.io/promises/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
