new Crawler({
  ...
  startUrls: [
    ...
    "https://docs.ropensci.org/tl/reference",
    "https://docs.ropensci.org/tl/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.ropensci.org/tl/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      indexName: "ropensci-tl",
      pathsToMatch: ["https://docs.ropensci.org/tl/index.html**/**"],
    ...
    {
      indexName: "ropensci-tl",
      pathsToMatch: ["https://docs.ropensci.org/tl/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "ropensci-tl",
      pathsToMatch: ["https://docs.ropensci.org/tl/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
