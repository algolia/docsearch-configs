new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["http://docs.rocketseat.dev/"],
  renderJavaScript: false,
  sitemaps: ["http://docs.rocketseat.dev/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["http://docs.rocketseat.dev/**"],
  schedule: "at 10:30 on Friday",
  actions: [
    {
      indexName: "rocketseat",
      pathsToMatch: ["http://docs.rocketseat.dev**/**"],
