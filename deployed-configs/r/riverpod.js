new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://riverpod.dev/docs/", "https://riverpod.dev/"],
  renderJavaScript: false,
  sitemaps: ["https://riverpod.dev/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://riverpod.dev/**"],
  schedule: "at 10:10 on Friday",
  actions: [
    {
      indexName: "riverpod",
      pathsToMatch: ["https://riverpod.dev/docs/**"],
