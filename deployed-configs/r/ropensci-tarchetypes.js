new Crawler({
  ...
  sitemaps: ["https://docs.ropensci.org/tarchetypes/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      indexName: "ropensci-tarchetypes",
      pathsToMatch: ["https://docs.ropensci.org/tarchetypes/index.html**/**"],
    ...
    {
      indexName: "ropensci-tarchetypes",
      pathsToMatch: ["https://docs.ropensci.org/tarchetypes/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "ropensci-tarchetypes",
      pathsToMatch: ["https://docs.ropensci.org/tarchetypes/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
