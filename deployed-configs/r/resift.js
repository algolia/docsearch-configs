new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://resift.org/docs/", "https://resift.org/"],
  renderJavaScript: false,
  sitemaps: ["https://resift.org/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://resift.org/**"],
  schedule: "at 10:00 on Friday",
  actions: [
    {
      indexName: "resift",
      pathsToMatch: ["https://resift.org/docs/**"],
