new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://docs.ropensci.org/vcr/index.html",
    "https://docs.ropensci.org/",
    "https://docs.ropensci.org/vcr/reference",
    "https://docs.ropensci.org/vcr/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.ropensci.org/vcr/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      indexName: "ropensci-vcr",
      pathsToMatch: ["https://docs.ropensci.org/vcr/index.html**/**"],
    ...
    {
      indexName: "ropensci-vcr",
      pathsToMatch: ["https://docs.ropensci.org/vcr/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "ropensci-vcr",
      pathsToMatch: ["https://docs.ropensci.org/vcr/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
