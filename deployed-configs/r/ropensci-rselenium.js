new Crawler({
  ...
  startUrls: [
    ...
    "https://docs.ropensci.org/RSelenium/reference",
    "https://docs.ropensci.org/RSelenium/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.ropensci.org/RSelenium/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      indexName: "ropensci-rselenium",
      pathsToMatch: ["https://docs.ropensci.org/RSelenium/index.html**/**"],
    ...
    {
      indexName: "ropensci-rselenium",
      pathsToMatch: ["https://docs.ropensci.org/RSelenium/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "ropensci-rselenium",
      pathsToMatch: ["https://docs.ropensci.org/RSelenium/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
