new Crawler({
  ...
  startUrls: [
    ...
    "https://docs.ropensci.org/gert/reference",
    "https://docs.ropensci.org/gert/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.ropensci.org/gert/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      indexName: "ropensci-gert",
      pathsToMatch: ["https://docs.ropensci.org/gert/index.html**/**"],
    ...
    {
      indexName: "ropensci-gert",
      pathsToMatch: ["https://docs.ropensci.org/gert/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "ropensci-gert",
      pathsToMatch: ["https://docs.ropensci.org/gert/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
