new Crawler({
  ...
  startUrls: [
    ...
    "https://docs.ropensci.org/rcrossref/reference",
    "https://docs.ropensci.org/rcrossref/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.ropensci.org/rcrossref/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      indexName: "ropensci-rcrossref",
      pathsToMatch: ["https://docs.ropensci.org/rcrossref/index.html**/**"],
    ...
    {
      indexName: "ropensci-rcrossref",
      pathsToMatch: ["https://docs.ropensci.org/rcrossref/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "ropensci-rcrossref",
      pathsToMatch: ["https://docs.ropensci.org/rcrossref/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
