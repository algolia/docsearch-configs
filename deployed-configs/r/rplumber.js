new Crawler({
  ...
  startUrls: [
    ...
    "https://www.rplumber.io/reference",
    "https://www.rplumber.io/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://www.rplumber.io/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  discoveryPatterns: ["https://www.rplumber.io/**"],
  schedule: "at 10:30 on Friday",
  actions: [
    {
      indexName: "rplumber",
      pathsToMatch: ["https://www.rplumber.io/index.html**/**"],
    ...
    {
      indexName: "rplumber",
      pathsToMatch: ["https://www.rplumber.io/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "rplumber",
      pathsToMatch: ["https://www.rplumber.io/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
