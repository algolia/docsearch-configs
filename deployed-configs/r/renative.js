new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://renative.org/docs/", "https://renative.org/"],
  renderJavaScript: false,
  sitemaps: ["https://renative.org/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://renative.org/**"],
  schedule: "at 10:00 on Friday",
  actions: [
    {
      indexName: "renative",
      pathsToMatch: ["https://renative.org/docs/**"],
