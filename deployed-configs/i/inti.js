new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://inkaverse.com/index.html",
    "https://inkaverse.com/",
    "https://inkaverse.com/reference",
    "https://inkaverse.com/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://inkaverse.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://inkaverse.com/**"],
  schedule: "at 15:30 on Wednesday",
  actions: [
    {
      indexName: "inti",
      pathsToMatch: ["https://inkaverse.com/index.html**/**"],
    ...
    {
      indexName: "inti",
      pathsToMatch: ["https://inkaverse.com/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "inti",
      pathsToMatch: ["https://inkaverse.com/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
