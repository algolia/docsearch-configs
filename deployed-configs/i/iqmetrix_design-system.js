new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://design-system.iqmetrix.net/docs/",
    "https://design-system.iqmetrix.net/",
    "https://design-system.iqmetrix.net/docs/foundations-and-experiences/ux-principles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://design-system.iqmetrix.net/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://design-system.iqmetrix.net/**"],
  schedule: "at 15:30 on Wednesday",
  actions: [
    {
      indexName: "iqmetrix_design-system",
      pathsToMatch: [
        "https://design-system.iqmetrix.net/docs/**",
        "https://design-system.iqmetrix.net/docs/foundations-and-experiences/ux-principles**/**",
      ],
