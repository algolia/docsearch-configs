new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://isomorphic-git.org/docs/",
    "https://isomorphic-git.org/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://isomorphic-git.org/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://isomorphic-git.org/**"],
  schedule: "at 15:40 on Wednesday",
  actions: [
    {
      indexName: "isomorphic_git",
      pathsToMatch: ["https://isomorphic-git.org/docs/**"],
