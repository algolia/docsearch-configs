new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://immunarch.com/index.html",
    "https://immunarch.com/",
    "https://immunarch.com/reference",
    "https://immunarch.com/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://immunarch.com/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  discoveryPatterns: ["https://immunarch.com/**"],
  schedule: "at 15:20 on Wednesday",
  actions: [
    {
      indexName: "immunarch",
      pathsToMatch: ["https://immunarch.com/index.html**/**"],
    ...
    {
      indexName: "immunarch",
      pathsToMatch: ["https://immunarch.com/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "immunarch",
      pathsToMatch: ["https://immunarch.com/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
