new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://docs.intilery.com/"],
  renderJavaScript: false,
  sitemaps: ["http://docs.intilery.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.intilery.com/**"],
  schedule: "at 15:30 on Wednesday",
  actions: [
    {
      indexName: "intilery",
      pathsToMatch: ["https://docs.intilery.com/**"],
