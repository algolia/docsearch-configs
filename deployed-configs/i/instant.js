new Crawler({
  ...
  startUrls: [
    ...
    "https://openhie.github.io/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://openhie.github.io/instant/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://openhie.github.io/**"],
  schedule: "at 15:30 on Wednesday",
  actions: [
    {
      indexName: "instant",
      pathsToMatch: ["https://openhie.github.io/instant/**"],
