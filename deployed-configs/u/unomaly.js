new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://docs.unomaly.com/"],
  renderJavaScript: false,
  sitemaps: ["https://docs.unomaly.com/sitemap.xml"],
  exclusionPatterns: [
    "https://docs.unomaly.com/d**",
    "https://docs.unomaly.com/d**/**",
  ],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.unomaly.com/**"],
  schedule: "at 00:30 on Saturday",
  actions: [
    {
      indexName: "unomaly",
      pathsToMatch: ["https://docs.unomaly.com/**"],
