new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://docs.umaproject.org/"],
  renderJavaScript: false,
  sitemaps: ["https://docs.umaproject.org/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.umaproject.org/**"],
  schedule: "at 00:20 on Saturday",
  actions: [
    {
      indexName: "umaproject",
      pathsToMatch: ["https://docs.umaproject.org/**"],
