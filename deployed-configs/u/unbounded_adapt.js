new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://adaptjs.org/docs/", "https://adaptjs.org/"],
  renderJavaScript: false,
  sitemaps: ["https://adaptjs.org/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://adaptjs.org/**"],
  schedule: "at 00:30 on Saturday",
  actions: [
    {
      indexName: "unbounded_adapt",
      pathsToMatch: ["https://adaptjs.org/docs/**"],
