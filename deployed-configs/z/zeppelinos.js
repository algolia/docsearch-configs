new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://docs.zeppelinos.org/docs/",
    "https://docs.zeppelinos.org/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.zeppelinos.org/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.zeppelinos.org/**"],
  schedule: "at 00:00 on Sunday",
  actions: [
    {
      indexName: "zeppelinos",
      pathsToMatch: ["https://docs.zeppelinos.org/docs/**"],
