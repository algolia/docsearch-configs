new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://ossoapp.com/docs/", "https://ossoapp.com/"],
  renderJavaScript: false,
  sitemaps: ["https://ossoapp.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://ossoapp.com/**"],
  schedule: "at 20:40 on Thursday",
  actions: [
    {
      indexName: "ossoapp",
      pathsToMatch: ["https://ossoapp.com/docs/**"],
