new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://ces.onex.dev/docs/", "https://ces.onex.dev/"],
  renderJavaScript: false,
  sitemaps: ["https://ces.onex.dev/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://ces.onex.dev/**"],
  schedule: "at 20:30 on Thursday",
  actions: [
    {
      indexName: "onex_ces",
      pathsToMatch: ["https://ces.onex.dev/docs/**"],
