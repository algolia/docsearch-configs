new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://overnode.org/docs/", "https://overnode.org/"],
  renderJavaScript: false,
  sitemaps: ["https://overnode.org/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://overnode.org/**"],
  schedule: "at 20:50 on Thursday",
  actions: [
    {
      indexName: "overnode",
      pathsToMatch: ["https://overnode.org/docs/**"],
