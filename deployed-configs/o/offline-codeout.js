new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://amon.membersfirst.now.sh/"],
  renderJavaScript: false,
  sitemaps: ["https://amon.membersfirst.now.sh/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://amon.membersfirst.now.sh/**"],
  schedule: "at 20:10 on Thursday",
  actions: [
    {
      indexName: "offline-codeout",
      pathsToMatch: ["https://amon.membersfirst.now.sh/**"],
