new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://docs.openpayments.dev/"],
  renderJavaScript: false,
  sitemaps: ["https://docs.openpayments.dev/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.openpayments.dev/**"],
  schedule: "at 20:30 on Thursday",
  actions: [
    {
      indexName: "openpayments",
      pathsToMatch: ["https://docs.openpayments.dev/**"],
