new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://router.vuejs.org/"],
  renderJavaScript: false,
  sitemaps: [],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://router.vuejs.org/**"],
  schedule: "at 05:40 on Saturday",
  actions: [
    {
      indexName: "vue-router",
      pathsToMatch: ["https://router.vuejs.org/**"],
      recordExtractor: ({ $, helpers }) => {
        return helpers.docsearch({
          recordProps: {
            lvl1: ".content__default h1",
            content:
              ".content__default p, .content__default li, .content__default table td:last-child",
            lvl0: {
