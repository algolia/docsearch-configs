new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://vaken-docs.now.sh/docs/",
    "https://vaken-docs.now.sh/",
    "https://vaken-docs.now.sh/docs/installation",
  ],
  renderJavaScript: false,
  sitemaps: ["https://vaken-docs.now.sh/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://vaken-docs.now.sh/**"],
