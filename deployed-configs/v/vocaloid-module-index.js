new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://www.mizuka.top/vocaloid-module-index/",
    "https://www.mizuka.top/",
  ],
  renderJavaScript: false,
  sitemaps: [],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://www.mizuka.top/**"],
  schedule: "at 05:30 on Saturday",
  actions: [
    {
      indexName: "vocaloid-module-index",
      pathsToMatch: ["https://www.mizuka.top/vocaloid-module-index/**"],
