new Crawler({
  ...
  startUrls: [
    ...
    "https://vuepress-theme-reco.recoluan.com/views/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://vuepress-theme-reco.recoluan.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://vuepress-theme-reco.recoluan.com/**"],
