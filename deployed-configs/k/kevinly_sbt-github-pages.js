new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://sbt-github-pages.kevinly.dev/docs/",
    "https://sbt-github-pages.kevinly.dev/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://sbt-github-pages.kevinly.dev/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://sbt-github-pages.kevinly.dev/**"],
  schedule: "at 01:00 on Thursday",
  actions: [
    {
      indexName: "kevinly_sbt-github-pages",
      pathsToMatch: ["https://sbt-github-pages.kevinly.dev/docs/**"],
