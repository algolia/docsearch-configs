new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://cloud.kili-technology.com/docs/",
  ...
  discoveryPatterns: ["https://cloud.kili-technology.com/**"],
  schedule: "at 01:10 on Thursday",
  actions: [
    {
      indexName: "kili-technology",
      pathsToMatch: ["https://cloud.kili-technology.com/docs/**"],
