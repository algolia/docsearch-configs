new Crawler({
  ...
  discoveryPatterns: ["https://docs.banuba.com/**"],
  schedule: "at 06:00 on Tuesday",
  actions: [
    {
      indexName: "banuba",
      pathsToMatch: ["https://docs.banuba.com/face-ar-sdk/**"],
    ...
    {
      indexName: "banuba",
      pathsToMatch: ["https://docs.banuba.com/face-ar-sdk-v1/**"],
      recordExtractor: ({ $, helpers }) => {
        return helpers.docsearch({
          recordProps: {
            lvl1: "header h1",
