new Crawler({
  ...
  sitemaps: ["https://getbootstrap.com/sitemap.xml"],
  exclusionPatterns: [
    "**/examples/**",
  ...
  discoveryPatterns: ["https://getbootstrap.com/**"],
  schedule: "at 06:30 on Tuesday",
  actions: [
    {
      indexName: "bootstrap",
      pathsToMatch: ["https://getbootstrap.com/docs/4.0/**"],
    ...
    {
      indexName: "bootstrap",
      pathsToMatch: ["https://getbootstrap.com/docs/4.1/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".bd-example";
        $(toRemove).remove();
    ...
    {
      indexName: "bootstrap",
      pathsToMatch: ["https://getbootstrap.com/docs/4.2/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".bd-example";
        $(toRemove).remove();
    ...
    {
      indexName: "bootstrap",
      pathsToMatch: ["https://getbootstrap.com/docs/5.0/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".bd-example";
        $(toRemove).remove();
