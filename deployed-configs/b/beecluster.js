new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "http://beecluster.csail.mit.edu/docs/",
    "http://beecluster.csail.mit.edu/",
    "http://beecluster.csail.mit.edu/docs/introduction",
  ],
  renderJavaScript: false,
  sitemaps: ["http://beecluster.csail.mit.edu/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["http://beecluster.csail.mit.edu/**"],
  schedule: "at 06:00 on Tuesday",
  actions: [
    {
      indexName: "beecluster",
      pathsToMatch: [
        "http://beecluster.csail.mit.edu/docs/**",
        "http://beecluster.csail.mit.edu/docs/introduction**/**",
      ],
