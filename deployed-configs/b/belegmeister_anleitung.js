new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://anleitung.belegmeister.de/docs/",
    "https://anleitung.belegmeister.de/",
    "https://anleitung.belegmeister.de/docs/einzelnutzerversion-faq/webanwendung/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://anleitung.belegmeister.de/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://anleitung.belegmeister.de/**"],
  schedule: "at 06:00 on Tuesday",
  actions: [
    {
      indexName: "belegmeister_anleitung",
      pathsToMatch: [
        "https://anleitung.belegmeister.de/docs/**",
        "https://anleitung.belegmeister.de/docs/einzelnutzerversion-faq/webanwendung/**",
      ],
