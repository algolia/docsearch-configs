new Crawler({
  ...
  startUrls: [
    ...
    "https://rstudio.github.io/bslib/reference",
    "https://rstudio.github.io/bslib/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://rstudio.github.io/bslib/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      indexName: "bslib",
      pathsToMatch: ["https://rstudio.github.io/bslib/index.html**/**"],
    ...
    {
      indexName: "bslib",
      pathsToMatch: ["https://rstudio.github.io/bslib/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "bslib",
      pathsToMatch: ["https://rstudio.github.io/bslib/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
