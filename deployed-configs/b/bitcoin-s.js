new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://bitcoin-s.org/docs/", "https://bitcoin-s.org/"],
  renderJavaScript: false,
  sitemaps: ["https://bitcoin-s.org/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://bitcoin-s.org/**"],
  schedule: "at 06:10 on Tuesday",
  actions: [
    {
      indexName: "bitcoin-s",
      pathsToMatch: ["https://bitcoin-s.org/docs/**"],
