new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://docs.blockpass.org/docs/",
    "https://docs.blockpass.org/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.blockpass.org/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.blockpass.org/**"],
  schedule: "at 06:20 on Tuesday",
  actions: [
    {
      indexName: "blockpass",
      pathsToMatch: ["https://docs.blockpass.org/docs/**"],
