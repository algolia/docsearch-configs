new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://docs.beakerbrowser.com/"],
  renderJavaScript: false,
  sitemaps: ["https://docs.beakerbrowser.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.beakerbrowser.com/**"],
  schedule: "at 06:00 on Tuesday",
  actions: [
    {
      indexName: "beakerbrowser",
      pathsToMatch: ["https://docs.beakerbrowser.com/**"],
