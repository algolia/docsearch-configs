new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["http://buildpacks.io/docs/", "http://buildpacks.io/"],
  renderJavaScript: false,
  sitemaps: ["http://buildpacks.io/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["http://buildpacks.io/**"],
  schedule: "at 06:40 on Tuesday",
  actions: [
    {
      indexName: "buildpacks",
      pathsToMatch: ["http://buildpacks.io/docs/**"],
