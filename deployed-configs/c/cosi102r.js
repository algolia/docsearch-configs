new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["http://cosi102r.s3-website-us-east-1.amazonaws.com/"],
  renderJavaScript: false,
  sitemaps: [],
  exclusionPatterns: ["**/images/**"],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["http://cosi102r.s3-website-us-east-1.amazonaws.com/**"],
  schedule: "at 11:30 on Tuesday",
  actions: [
    {
      indexName: "cosi102r",
      pathsToMatch: ["http://cosi102r.s3-website-us-east-1.amazonaws.com/**"],
