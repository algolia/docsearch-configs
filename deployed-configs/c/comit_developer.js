new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://comit.network/docs/", "https://comit.network/"],
  renderJavaScript: false,
  sitemaps: ["https://comit.network/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://comit.network/**"],
  schedule: "at 11:30 on Tuesday",
  actions: [
    {
      indexName: "comit_developer",
      pathsToMatch: ["https://comit.network/docs/**"],
