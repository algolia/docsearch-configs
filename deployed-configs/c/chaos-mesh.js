new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://chaos-mesh.org/docs/", "https://chaos-mesh.org/"],
  renderJavaScript: false,
  sitemaps: ["https://chaos-mesh.org/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://chaos-mesh.org/**"],
  schedule: "at 11:10 on Tuesday",
  actions: [
    {
      indexName: "chaos-mesh",
      pathsToMatch: ["https://chaos-mesh.org/docs/**"],
