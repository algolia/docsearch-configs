new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["http://docs.3steps.cn/docs/", "http://docs.3steps.cn/"],
  renderJavaScript: false,
  sitemaps: ["http://docs.3steps.cn/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["http://docs.3steps.cn/**"],
  schedule: "at 11:10 on Tuesday",
  actions: [
    {
      indexName: "choppy",
      pathsToMatch: ["http://docs.3steps.cn/docs/**"],
