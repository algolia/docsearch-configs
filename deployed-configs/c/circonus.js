new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://docs.circonus.com/"],
  renderJavaScript: false,
  sitemaps: ["https://docs.circonus.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.circonus.com/**"],
  schedule: "at 11:10 on Tuesday",
  actions: [
    {
      indexName: "circonus",
      pathsToMatch: ["https://docs.circonus.com**/**"],
