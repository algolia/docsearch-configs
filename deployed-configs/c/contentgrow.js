new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://help.contentgrow.com/"],
  renderJavaScript: false,
  sitemaps: ["https://help.contentgrow.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://help.contentgrow.com/**"],
  schedule: "at 11:30 on Tuesday",
  actions: [
    {
      indexName: "contentgrow",
      pathsToMatch: ["https://help.contentgrow.com/**"],
