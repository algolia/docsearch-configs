new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://docs.cosmos.network/"],
  renderJavaScript: false,
  sitemaps: ["https://docs.cosmos.network/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.cosmos.network/**"],
  schedule: "at 11:30 on Tuesday",
  actions: [
    {
      indexName: "cosmos-sdk",
      pathsToMatch: ["https://docs.cosmos.network/**"],
