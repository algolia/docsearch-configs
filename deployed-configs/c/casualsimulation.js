new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://docs.casualsimulation.com/docs/",
    "https://docs.casualsimulation.com/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.casualsimulation.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.casualsimulation.com/**"],
  schedule: "at 11:00 on Tuesday",
  actions: [
    {
      indexName: "casualsimulation",
      pathsToMatch: ["https://docs.casualsimulation.com/docs/**"],
