new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://docs.capture.techulus.in/docs/get-started",
    "https://docs.capture.techulus.in/",
    "https://docs.capture.techulus.in/docs/",
  ],
  renderJavaScript: false,
  sitemaps: [],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.capture.techulus.in/**"],
