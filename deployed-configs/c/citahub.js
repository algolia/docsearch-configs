new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://docs.citahub.com/"],
  renderJavaScript: false,
  sitemaps: ["https://docs.citahub.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.citahub.com/**"],
  schedule: "at 11:10 on Tuesday",
  actions: [
    {
      indexName: "citahub",
      pathsToMatch: ["https://docs.citahub.com/**"],
