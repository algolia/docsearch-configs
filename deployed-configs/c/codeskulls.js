new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://codeskulls.com/"],
  renderJavaScript: false,
  sitemaps: ["https://codeskulls.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://codeskulls.com/**"],
  schedule: "at 11:30 on Tuesday",
  actions: [
    {
      indexName: "codeskulls",
      pathsToMatch: ["https://codeskulls.com/**"],
