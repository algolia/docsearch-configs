new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://doc.comexposium-sso.com/"],
  renderJavaScript: false,
  sitemaps: [],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://doc.comexposium-sso.com/**"],
  schedule: "at 11:30 on Tuesday",
  actions: [
    {
      indexName: "comexposium-sso",
      pathsToMatch: ["https://doc.comexposium-sso.com/**"],
