new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://syllabus.codeyourfuture.io/"],
  renderJavaScript: false,
  sitemaps: ["https://syllabus.codeyourfuture.io/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://syllabus.codeyourfuture.io/**"],
  schedule: "at 11:30 on Tuesday",
  actions: [
    {
      indexName: "codeyourfuture_syllabus",
      pathsToMatch: ["https://syllabus.codeyourfuture.io/**"],
