new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://developer.centrifuge.io/docs/",
    "https://developer.centrifuge.io/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://developer.centrifuge.io/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://developer.centrifuge.io/**"],
  schedule: "at 11:00 on Tuesday",
  actions: [
    {
      indexName: "centrifuge",
      pathsToMatch: ["https://developer.centrifuge.io/docs/**"],
