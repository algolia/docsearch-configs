new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://cooking-log.now.sh/"],
  renderJavaScript: false,
  sitemaps: ["https://cooking-log.now.sh/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://cooking-log.now.sh/**"],
  schedule: "at 11:30 on Tuesday",
  actions: [
    {
      indexName: "cooking-log",
      pathsToMatch: ["https://cooking-log.now.sh/**"],
