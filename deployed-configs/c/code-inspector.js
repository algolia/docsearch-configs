new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://doc.code-inspector.com/"],
  renderJavaScript: false,
  sitemaps: ["https://doc.code-inspector.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://doc.code-inspector.com/**"],
  schedule: "at 11:30 on Tuesday",
  actions: [
    {
      indexName: "code-inspector",
      pathsToMatch: ["https://doc.code-inspector.com/**"],
