new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://ckeditor5.github.io/docs/nightly/ckeditor5/latest/api/",
    "https://ckeditor5.github.io/",
    "https://ckeditor5.github.io/docs/nightly/ckeditor5/latest/framework/",
    "https://ckeditor5.github.io/docs/nightly/ckeditor5/latest/builds/",
    "https://ckeditor5.github.io/docs/nightly/ckeditor5/latest/features/",
    "https://ckeditor5.github.io/docs/nightly/ckeditor5/latest/examples/",
  ],
  ...
  discoveryPatterns: ["https://ckeditor5.github.io/**"],
      ...
      recordExtractor: ({ $, helpers }) => {
        ...
        return helpers.docsearch({
          recordProps: {
            ...
            tags: {
              defaultValue: ["framework", "ckeditor5"],
            },
          },
          indexHeadings: { from: 1, to: 6 },
        });
      ...
      recordExtractor: ({ $, helpers }) => {
        ...
        return helpers.docsearch({
          recordProps: {
            ...
            lvl5: ".main__content h5",
            tags: {
              defaultValue: ["features", "ckeditor5"],
            },
          },
          indexHeadings: { from: 1, to: 6 },
        });
      ...
      recordExtractor: ({ $, helpers }) => {
        ...
        return helpers.docsearch({
          recordProps: {
            ...
            lvl5: ".main__content h5",
            tags: {
              defaultValue: ["examples", "ckeditor5"],
            },
          },
          indexHeadings: { from: 1, to: 6 },
        });
