new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["http://cosi119r.s3-website-us-west-2.amazonaws.com/"],
  renderJavaScript: false,
  sitemaps: [],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["http://cosi119r.s3-website-us-west-2.amazonaws.com/**"],
  schedule: "at 11:30 on Tuesday",
  actions: [
    {
      indexName: "cosi119r",
      pathsToMatch: ["http://cosi119r.s3-website-us-west-2.amazonaws.com/**"],
