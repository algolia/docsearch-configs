new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://wintercms.com/docs/", "https://wintercms.com/"],
  renderJavaScript: false,
  sitemaps: ["https://wintercms.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://wintercms.com/**"],
  schedule: "at 10:10 on Saturday",
  actions: [
    {
      indexName: "wintercms",
      pathsToMatch: ["https://wintercms.com/docs/**"],
