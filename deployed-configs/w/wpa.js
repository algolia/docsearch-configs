new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://microsoft.github.io/wpa/index.html",
    "https://microsoft.github.io/",
    "https://microsoft.github.io/wpa/reference",
    "https://microsoft.github.io/wpa/articles",
  ],
  ...
  actions: [
    {
      indexName: "wpa",
      pathsToMatch: ["https://microsoft.github.io/wpa/index.html**/**"],
    ...
    {
      indexName: "wpa",
      pathsToMatch: ["https://microsoft.github.io/wpa/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "wpa",
      pathsToMatch: ["https://microsoft.github.io/wpa/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
