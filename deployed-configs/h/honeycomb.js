new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://docs.honeycomb.io/"],
  renderJavaScript: false,
  sitemaps: [],
  exclusionPatterns: ["**/pricing/**", "**/customers/**", "**/blog/**"],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.honeycomb.io/**"],
  schedule: "at 10:30 on Wednesday",
  actions: [
    {
      indexName: "honeycomb",
      pathsToMatch: ["https://docs.honeycomb.io/**"],
