new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://docs.healthcare.ai/"],
  renderJavaScript: false,
  sitemaps: ["https://docs.healthcare.ai/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.healthcare.ai/**"],
  schedule: "at 10:00 on Wednesday",
  actions: [
    {
      indexName: "healthcareai",
      pathsToMatch: ["https://docs.healthcare.ai/**"],
