new Crawler({
  ...
  startUrls: [
    ...
    "https://rstudio.github.io/htmltools/reference",
    "https://rstudio.github.io/htmltools/articles",
  ],
  ...
  actions: [
    {
      indexName: "htmltools",
      pathsToMatch: ["https://rstudio.github.io/htmltools/index.html**/**"],
    ...
    {
      indexName: "htmltools",
      pathsToMatch: ["https://rstudio.github.io/htmltools/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "htmltools",
      pathsToMatch: ["https://rstudio.github.io/htmltools/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
