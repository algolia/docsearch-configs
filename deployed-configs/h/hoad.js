new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://subugoe.github.io/hoad/index.html",
    "https://subugoe.github.io/",
    "https://subugoe.github.io/hoad/reference",
    "https://subugoe.github.io/hoad/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://subugoe.github.io/hoad/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      indexName: "hoad",
      pathsToMatch: ["https://subugoe.github.io/hoad/index.html**/**"],
    ...
    {
      indexName: "hoad",
      pathsToMatch: ["https://subugoe.github.io/hoad/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "hoad",
      pathsToMatch: ["https://subugoe.github.io/hoad/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
