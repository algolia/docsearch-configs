new Crawler({
  ...
  startUrls: [
    ...
    "https://jkunst.com/",
    "https://jkunst.com/highcharter/reference",
    "https://jkunst.com/highcharter/articles",
  ],
  ...
  discoveryPatterns: ["https://jkunst.com/**"],
  schedule: "at 10:10 on Wednesday",
  actions: [
    {
      indexName: "highcharter",
      pathsToMatch: ["https://jkunst.com/highcharter/index.html**/**"],
    ...
    {
      indexName: "highcharter",
      pathsToMatch: ["https://jkunst.com/highcharter/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "highcharter",
      pathsToMatch: ["https://jkunst.com/highcharter/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
