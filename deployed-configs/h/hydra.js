new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://hydra.cc/docs/", "https://hydra.cc/"],
  renderJavaScript: false,
  sitemaps: ["https://hydra.cc/sitemap.xml"],
  exclusionPatterns: ["**/fb/**"],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://hydra.cc/**"],
  schedule: "at 10:50 on Wednesday",
  actions: [
    {
      indexName: "hydra",
      pathsToMatch: ["https://hydra.cc/docs/**"],
