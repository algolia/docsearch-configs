new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://integrate.spektrix.com/docs/Introduction",
    "https://integrate.spektrix.com/",
    "https://integrate.spektrix.com/docs/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://integrate.spektrix.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://integrate.spektrix.com/**"],
