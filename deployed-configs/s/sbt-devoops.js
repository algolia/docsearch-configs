new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://sbt-devoops.kevinly.dev/docs/",
    "https://sbt-devoops.kevinly.dev/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://sbt-devoops.kevinly.dev/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://sbt-devoops.kevinly.dev/**"],
  schedule: "at 15:00 on Friday",
  actions: [
    {
      indexName: "sbt-devoops",
      pathsToMatch: ["https://sbt-devoops.kevinly.dev/docs/**"],
