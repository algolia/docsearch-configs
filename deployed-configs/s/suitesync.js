new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://dashboard.suitesync.io/docs/",
    "https://dashboard.suitesync.io/",
  ],
  renderJavaScript: false,
  sitemaps: [],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://dashboard.suitesync.io/**"],
  schedule: "at 15:40 on Friday",
  actions: [
    {
      indexName: "suitesync",
      pathsToMatch: ["https://dashboard.suitesync.io/docs/**"],
