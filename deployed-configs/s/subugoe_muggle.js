new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://subugoe.github.io/muggle/index.html",
    "https://subugoe.github.io/",
    "https://subugoe.github.io/muggle/reference",
    "https://subugoe.github.io/muggle/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://subugoe.github.io/muggle/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      ...
      pathsToMatch: ["https://subugoe.github.io/muggle/index.html**/**"],
    ...
    {
      indexName: "subugoe_muggle",
      pathsToMatch: ["https://subugoe.github.io/muggle/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "subugoe_muggle",
      pathsToMatch: ["https://subugoe.github.io/muggle/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
