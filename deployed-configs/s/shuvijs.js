new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://shuvijs.github.io/shuvijs.org/docs/",
    "https://shuvijs.github.io/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://shuvijs.github.io/shuvijs.org/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://shuvijs.github.io/**"],
  schedule: "at 15:10 on Friday",
  actions: [
    {
      indexName: "shuvijs",
      pathsToMatch: ["https://shuvijs.github.io/shuvijs.org/docs/**"],
