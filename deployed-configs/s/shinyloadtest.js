new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://rstudio.github.io/shinyloadtest/index.html",
    "https://rstudio.github.io/",
    "https://rstudio.github.io/shinyloadtest/reference",
    "https://rstudio.github.io/shinyloadtest/articles",
  ],
  ...
  actions: [
    {
      ...
      pathsToMatch: ["https://rstudio.github.io/shinyloadtest/index.html**/**"],
    ...
    {
      indexName: "shinyloadtest",
      pathsToMatch: ["https://rstudio.github.io/shinyloadtest/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "shinyloadtest",
      pathsToMatch: ["https://rstudio.github.io/shinyloadtest/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
