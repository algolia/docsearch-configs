new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://sorbet.org/docs/", "https://sorbet.org/"],
  renderJavaScript: false,
  sitemaps: ["https://sorbet.org/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://sorbet.org/**"],
  schedule: "at 15:40 on Friday",
  actions: [
    {
      indexName: "stripe_sorbet",
      pathsToMatch: ["https://sorbet.org/docs/**"],
