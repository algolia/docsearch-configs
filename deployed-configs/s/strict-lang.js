new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://strict.dev/docs/", "https://strict.dev/"],
  renderJavaScript: false,
  sitemaps: ["https://strict.dev/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://strict.dev/**"],
  schedule: "at 15:40 on Friday",
  actions: [
    {
      indexName: "strict-lang",
      pathsToMatch: ["https://strict.dev/docs/**"],
