new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://docs.pacific-data.sprep.org/docs/",
    "https://docs.pacific-data.sprep.org/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.pacific-data.sprep.org/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.pacific-data.sprep.org/**"],
  schedule: "at 15:30 on Friday",
  actions: [
    {
      indexName: "sprep_inform",
      pathsToMatch: ["https://docs.pacific-data.sprep.org/docs/**"],
