new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://docs.steinhq.com/"],
  renderJavaScript: false,
  sitemaps: ["https://docs.steinhq.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.steinhq.com/**"],
  schedule: "at 15:40 on Friday",
  actions: [
    {
      indexName: "steinhq",
      pathsToMatch: ["https://docs.steinhq.com**/**"],
