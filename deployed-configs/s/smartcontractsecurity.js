new Crawler({
  ...
  startUrls: [
    ...
    "https://smartcontractsecurity.github.io/",
  ...
  discoveryPatterns: ["https://smartcontractsecurity.github.io/**"],
  ...
  actions: [
    {
      ...
      recordExtractor: ({ $, helpers }) => {
        ...
        return helpers.docsearch({
          recordProps: {
            lvl1: ".post h1:not(.postHeaderTitle)",
            content: ".post article p, .post article li",
            lvl0: {
              selectors: ".post h1.postHeaderTitle",
