new Crawler({
  ...
  discoveryPatterns: ["https://g2plot.antv.vision/**"],
  schedule: "at 01:30 on Tuesday",
  actions: [
    {
      indexName: "antv_g2plot",
      pathsToMatch: ["https://g2plot.antv.vision/zh**/**"],
      recordExtractor: ({ $, helpers }) => {
        return helpers.docsearch({
          recordProps: {
            ...
            lvl2: "article h2, a[aria-current=page] h2",
            lvl3: "article h3",
            lvl4: "article h4",
            lvl5: "article h5",
            tags: {
    ...
    {
      indexName: "antv_g2plot",
      pathsToMatch: ["https://g2plot.antv.vision/en**/**"],
      recordExtractor: ({ $, helpers }) => {
        return helpers.docsearch({
          recordProps: {
            lvl1: "article h1, .banner-title",
