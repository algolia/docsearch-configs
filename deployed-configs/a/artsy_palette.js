new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://palette.artsy.net/"],
  renderJavaScript: false,
  sitemaps: ["https://palette.artsy.net/sitemap.xml"],
  exclusionPatterns: ["**/changelog/**"],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://palette.artsy.net/**"],
  schedule: "at 01:40 on Tuesday",
  actions: [
    {
      indexName: "artsy_palette",
      pathsToMatch: ["https://palette.artsy.net/**"],
