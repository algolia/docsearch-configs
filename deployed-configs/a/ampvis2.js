new Crawler({
  ...
  startUrls: [
    ...
    "https://madsalbertsen.github.io/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://madsalbertsen.github.io/ampvis2/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://madsalbertsen.github.io/**"],
  schedule: "at 01:20 on Tuesday",
  actions: [
    {
      indexName: "ampvis2",
      pathsToMatch: ["https://madsalbertsen.github.io/ampvis2/**"],
