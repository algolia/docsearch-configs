new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["http://www.agilebpm.cn/"],
  renderJavaScript: false,
  sitemaps: ["http://www.agilebpm.cn/sitemap.xml"],
  exclusionPatterns: ["**/**index.html", "**/more/"],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["http://www.agilebpm.cn/**"],
  schedule: "at 01:10 on Tuesday",
  actions: [
    {
      indexName: "agilebpm",
      pathsToMatch: ["http://www.agilebpm.cn/**"],
