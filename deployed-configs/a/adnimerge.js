new Crawler({
  ...
  startUrls: [
    ...
    "https://adni.bitbucket.io/reference",
    "https://adni.bitbucket.io/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://adni.bitbucket.io/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  discoveryPatterns: ["https://adni.bitbucket.io/**"],
  schedule: "at 01:00 on Tuesday",
  actions: [
    {
      indexName: "adnimerge",
      pathsToMatch: ["https://adni.bitbucket.io/index.html**/**"],
    ...
    {
      indexName: "adnimerge",
      pathsToMatch: ["https://adni.bitbucket.io/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "adnimerge",
      pathsToMatch: ["https://adni.bitbucket.io/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
