new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://docs.admix.in/docs/",
    "https://docs.admix.in/",
    "https://docs.admix.in/docs/getting-started/admix-quickstart/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.admix.in/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.admix.in/**"],
