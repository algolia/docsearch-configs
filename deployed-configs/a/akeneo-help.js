new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://help.akeneo.com/"],
  renderJavaScript: false,
  sitemaps: [],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://help.akeneo.com/**"],
  schedule: "at 01:20 on Tuesday",
  actions: [
    {
      indexName: "akeneo-help",
      pathsToMatch: ["https://help.akeneo.com/**"],
  ...
  initialIndexSettings: {
    "akeneo-help": {
      attributesForFaceting: ["type", "lang", "solution"],
