new Crawler({
  ...
  startUrls: [
    ...
    "https://uqrmaie1.github.io/",
    "https://uqrmaie1.github.io/admixtools/reference",
    "https://uqrmaie1.github.io/admixtools/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://uqrmaie1.github.io/admixtools/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  discoveryPatterns: ["https://uqrmaie1.github.io/**"],
  schedule: "at 01:00 on Tuesday",
  actions: [
    {
      indexName: "admixtools",
      pathsToMatch: ["https://uqrmaie1.github.io/admixtools/index.html**/**"],
    ...
    {
      indexName: "admixtools",
      pathsToMatch: ["https://uqrmaie1.github.io/admixtools/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "admixtools",
      pathsToMatch: ["https://uqrmaie1.github.io/admixtools/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
