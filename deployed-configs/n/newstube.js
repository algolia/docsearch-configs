new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "http://newstube.cactusthemes.com/doc/",
    "http://newstube.cactusthemes.com/",
  ],
  renderJavaScript: true,
  sitemaps: [],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["http://newstube.cactusthemes.com/**"],
  schedule: "at 15:00 on Thursday",
  actions: [
    {
      indexName: "newstube",
      pathsToMatch: ["http://newstube.cactusthemes.com/doc/**"],
