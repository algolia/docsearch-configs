new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://docs-old.nervos.org/"],
  renderJavaScript: false,
  sitemaps: ["https://docs-old.nervos.org/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs-old.nervos.org/**"],
  schedule: "at 15:00 on Thursday",
  actions: [
    {
      indexName: "nervos-ckb",
      pathsToMatch: ["https://docs-old.nervos.org/**"],
