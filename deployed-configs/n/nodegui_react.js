new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://react.nodegui.org/docs/", "https://react.nodegui.org/"],
  renderJavaScript: false,
  sitemaps: ["https://react.nodegui.org/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://react.nodegui.org/**"],
  schedule: "at 15:30 on Thursday",
  actions: [
    {
      indexName: "nodegui_react",
      pathsToMatch: ["https://react.nodegui.org/docs/**"],
