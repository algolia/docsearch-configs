new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://nodecg.com/docs/", "https://nodecg.com/"],
  renderJavaScript: false,
  sitemaps: ["https://nodecg.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://nodecg.com/**"],
  schedule: "at 15:30 on Thursday",
  actions: [
    {
      indexName: "nodecg",
      pathsToMatch: ["https://nodecg.com/docs/**"],
