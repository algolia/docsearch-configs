new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://nus-tic2002-2021.github.io/website/schedule/",
    "https://nus-tic2002-2021.github.io/",
    "https://nus-tic2002-2021.github.io/website/admin/",
    "https://nus-tic2002-2021.github.io/website/se-book-adapted/",
  ...
  discoveryPatterns: ["https://nus-tic2002-2021.github.io/**"],
  schedule: "at 15:40 on Thursday",
  actions: [
    {
      indexName: "nus-tic2002-2020",
      pathsToMatch: ["https://nus-tic2002-2021.github.io/website/schedule/**"],
    ...
    {
      indexName: "nus-tic2002-2020",
      pathsToMatch: ["https://nus-tic2002-2021.github.io/website/admin/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".algolia-no-index, [id$='-toc'], #toc, .alert";
        $(toRemove).remove();
