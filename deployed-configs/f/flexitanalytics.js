new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://learn.flexitanalytics.com/docs/",
    "https://learn.flexitanalytics.com/",
    "https://learn.flexitanalytics.com/docs/getting-started",
  ],
  renderJavaScript: false,
  sitemaps: ["https://learn.flexitanalytics.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://learn.flexitanalytics.com/**"],
