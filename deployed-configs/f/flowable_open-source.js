new Crawler({
  ...
  sitemaps: ["https://flowable.com/open-source/docs/sitemap.xml"],
  exclusionPatterns: ["**/**javadocs/**", "**/javadoc/**"],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://flowable.com/**"],
  schedule: "at 01:20 on Wednesday",
  actions: [
    {
      indexName: "flowable_open-source",
      pathsToMatch: ["https://flowable.com/open-source/docs/**"],
