new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://feature-hub.io/docs/", "https://feature-hub.io/"],
  renderJavaScript: false,
  sitemaps: ["https://feature-hub.io/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://feature-hub.io/**"],
  schedule: "at 01:00 on Wednesday",
  actions: [
    {
      indexName: "feature-hub",
      pathsToMatch: ["https://feature-hub.io/docs/**"],
