new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://flowcontrol12.github.io/"],
  renderJavaScript: false,
  sitemaps: ["https://flowcontrol12.github.io/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://flowcontrol12.github.io/**"],
  schedule: "at 01:20 on Wednesday",
  actions: [
    {
      indexName: "flowcontrol12",
      pathsToMatch: ["https://flowcontrol12.github.io/**"],
