new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://fbinfer.com/docs/", "https://fbinfer.com/"],
  renderJavaScript: false,
  sitemaps: ["https://fbinfer.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://fbinfer.com/**"],
  schedule: "at 01:00 on Wednesday",
  actions: [
    {
      indexName: "fbinfer",
      pathsToMatch: ["https://fbinfer.com/docs/**"],
