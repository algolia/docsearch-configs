new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://ob7-ird.github.io/furdeb/index.html",
    "https://ob7-ird.github.io/",
    "https://ob7-ird.github.io/furdeb/reference",
    "https://ob7-ird.github.io/furdeb/articles",
  ],
  ...
  actions: [
    {
      indexName: "furedb",
      pathsToMatch: ["https://ob7-ird.github.io/furdeb/index.html**/**"],
    ...
    {
      indexName: "furedb",
      pathsToMatch: ["https://ob7-ird.github.io/furdeb/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "furedb",
      pathsToMatch: ["https://ob7-ird.github.io/furdeb/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
