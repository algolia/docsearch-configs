new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://foxdocs.foxoms.com/"],
  renderJavaScript: false,
  sitemaps: ["https://foxdocs.foxoms.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://foxdocs.foxoms.com/**"],
  schedule: "at 01:30 on Wednesday",
  actions: [
    {
      indexName: "foxoms",
      pathsToMatch: ["https://foxdocs.foxoms.com/**"],
