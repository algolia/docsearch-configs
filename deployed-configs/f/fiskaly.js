new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["http://developer.fiskaly.com/"],
  renderJavaScript: false,
  sitemaps: ["http://developer.fiskaly.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["http://developer.fiskaly.com/**"],
  schedule: "at 01:10 on Wednesday",
  actions: [
    {
      indexName: "fiskaly",
      pathsToMatch: ["http://developer.fiskaly.com/**"],
