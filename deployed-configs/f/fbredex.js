new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://fbredex.com/docs/", "https://fbredex.com/"],
  renderJavaScript: false,
  sitemaps: ["https://fbredex.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://fbredex.com/**"],
  schedule: "at 01:00 on Wednesday",
  actions: [
    {
      indexName: "fbredex",
      pathsToMatch: ["https://fbredex.com/docs/**"],
