  ...
  actions: [
    {
      ...
      pathsToMatch: ['https://*.futureverse.org/index.html**/**'],
      recordExtractor: ({ $, helpers, url }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = '.dont-index';
        $(toRemove).remove();
        const project = url.hostname.replace('.futureverse.org', '');
    ...
    {
      indexName: 'futureverse',
      pathsToMatch: ['https://*.futureverse.org/reference**/**'],
      recordExtractor: ({ $, helpers, url }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = '.dont-index';
        $(toRemove).remove();
    ...
    {
      indexName: 'futureverse',
      pathsToMatch: ['https://*.futureverse.org/articles**/**'],
      recordExtractor: ({ $, helpers, url }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = '.dont-index';
        $(toRemove).remove();
