new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://qtpromise.netlify.app/"],
  renderJavaScript: false,
  sitemaps: [],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://qtpromise.netlify.app/**"],
  schedule: "at 05:40 on Friday",
  actions: [
    {
      indexName: "qtpromise",
      pathsToMatch: ["https://qtpromise.netlify.app**/**"],
      recordExtractor: ({ $, helpers }) => {
        return helpers.docsearch({
          recordProps: {
            ...
            lvl0: {
              selectors:
                "p.sidebar-heading.open, ul.sidebar-links > li > .active.sidebar-link",
