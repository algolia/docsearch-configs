new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://queuery.com/docs/", "https://queuery.com/"],
  renderJavaScript: false,
  sitemaps: ["https://queuery.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://queuery.com/**"],
  schedule: "at 05:40 on Friday",
  actions: [
    {
      indexName: "queuery",
      pathsToMatch: ["https://queuery.com/docs/**"],
