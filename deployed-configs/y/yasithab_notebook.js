new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://notebook.yasithab.com/"],
  renderJavaScript: false,
  sitemaps: ["https://notebook.yasithab.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://notebook.yasithab.com/**"],
  schedule: "at 19:00 on Saturday",
  actions: [
    {
      indexName: "yasithab_notebook",
      pathsToMatch: ["https://notebook.yasithab.com/**"],
