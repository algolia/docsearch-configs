new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://easymoney.now.sh/docs/",
    "https://easymoney.now.sh/",
    "https://easymoney.now.sh/docs/introduction/getting-started",
  ],
  renderJavaScript: false,
  sitemaps: ["https://easymoney.now.sh/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://easymoney.now.sh/**"],
