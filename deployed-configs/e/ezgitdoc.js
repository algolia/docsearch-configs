new Crawler({
  ...
  startUrls: [
    ...
    "https://os-expected.github.io/",
  ],
  renderJavaScript: false,
  sitemaps: [
    "https://os-expected.github.io/EzGitDoc-documentation/sitemap.xml",
  ],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://os-expected.github.io/**"],
  schedule: "at 20:50 on Tuesday",
  actions: [
    {
      indexName: "ezgitdoc",
      pathsToMatch: ["https://os-expected.github.io/EzGitDoc-documentation/**"],
