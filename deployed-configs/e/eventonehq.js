new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://help.event1.io/"],
  renderJavaScript: false,
  sitemaps: ["https://help.event1.io/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://help.event1.io/**"],
  schedule: "at 20:50 on Tuesday",
  actions: [
    {
      indexName: "eventonehq",
      pathsToMatch: ["https://help.event1.io/**"],
