new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://eaedocs.elementoraddons.com/docs/",
    "https://eaedocs.elementoraddons.com/",
    "https://eaedocs.elementoraddons.com/docs/getting-started/installation",
  ],
  renderJavaScript: false,
  sitemaps: ["https://eaedocs.elementoraddons.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://eaedocs.elementoraddons.com/**"],
