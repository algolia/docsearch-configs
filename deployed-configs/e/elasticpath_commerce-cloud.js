new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://documentation.elasticpath.com/commerce-cloud/docs/",
    "https://documentation.elasticpath.com/",
  ],
  renderJavaScript: false,
  sitemaps: [
    "https://documentation.elasticpath.com/commerce-cloud/sitemap.xml",
  ],
  exclusionPatterns: [],
  ...
  actions: [
    {
      indexName: "elasticpath_commerce-cloud",
      pathsToMatch: [
        "https://documentation.elasticpath.com/commerce-cloud/docs/**",
      ],
