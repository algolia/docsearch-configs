new Crawler({
  ...
  startUrls: [
    ...
    "https://epiforecasts.io/EpiNow2/news/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://epiforecasts.io/EpiNow2/sitemap.xml"],
  exclusionPatterns: [
  ...
  actions: [
    {
      indexName: "epinow2",
      pathsToMatch: ["https://epiforecasts.io/EpiNow2/**"],
    ...
    {
      indexName: "epinow2",
      pathsToMatch: ["https://epiforecasts.io/EpiNow2/reference/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "epinow2",
      pathsToMatch: ["https://epiforecasts.io/EpiNow2/news/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
