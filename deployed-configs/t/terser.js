new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://terser.org/docs/", "https://terser.org/"],
  renderJavaScript: false,
  sitemaps: ["https://terser.org/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://terser.org/**"],
  schedule: "at 19:00 on Friday",
  actions: [
    {
      indexName: "terser",
      pathsToMatch: ["https://terser.org/docs/**"],
