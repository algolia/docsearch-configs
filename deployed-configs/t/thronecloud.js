new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://support.qredo.com/"],
  renderJavaScript: false,
  sitemaps: ["https://support.qredo.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://support.qredo.com/**"],
  schedule: "at 19:10 on Friday",
  actions: [
    {
      indexName: "thronecloud",
      pathsToMatch: ["https://support.qredo.com/**"],
