new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://aide.teoapp.fr/docs/",
    "https://aide.teoapp.fr/",
    "https://aide.teoapp.fr/docs/a-propos",
  ],
  renderJavaScript: false,
  sitemaps: ["https://aide.teoapp.fr/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://aide.teoapp.fr/**"],
  schedule: "at 19:00 on Friday",
  actions: [
    {
      indexName: "teoapp_aide",
      pathsToMatch: [
        "https://aide.teoapp.fr/docs/**",
        "https://aide.teoapp.fr/docs/a-propos**/**",
      ],
