new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "http://truemag.cactusthemes.com/doc/",
    "http://truemag.cactusthemes.com/",
  ],
  renderJavaScript: true,
  sitemaps: [],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["http://truemag.cactusthemes.com/**"],
  schedule: "at 19:40 on Friday",
  actions: [
    {
      indexName: "truemag",
      pathsToMatch: ["http://truemag.cactusthemes.com/doc/**"],
