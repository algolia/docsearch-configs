new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://tartiflette.io/docs/", "https://tartiflette.io/"],
  renderJavaScript: false,
  sitemaps: ["https://tartiflette.io/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://tartiflette.io/**"],
  schedule: "at 19:00 on Friday",
  actions: [
    {
      indexName: "tartiflette",
      pathsToMatch: ["https://tartiflette.io/docs/**"],
