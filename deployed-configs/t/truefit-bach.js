new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://bach.truefit.io/docs/", "https://bach.truefit.io/"],
  renderJavaScript: false,
  sitemaps: ["https://bach.truefit.io/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://bach.truefit.io/**"],
  schedule: "at 19:40 on Friday",
  actions: [
    {
      indexName: "truefit-bach",
      pathsToMatch: ["https://bach.truefit.io/docs/**"],
