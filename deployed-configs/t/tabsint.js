new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["http://tabsint.org/docs/", "http://tabsint.org/"],
  renderJavaScript: false,
  sitemaps: ["http://tabsint.org/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["http://tabsint.org/**"],
  schedule: "at 19:00 on Friday",
  actions: [
    {
      indexName: "tabsint",
      pathsToMatch: ["http://tabsint.org/docs/**"],
