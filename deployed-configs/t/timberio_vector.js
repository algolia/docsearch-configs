new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://vector.dev/docs/", "https://vector.dev/"],
  renderJavaScript: false,
  sitemaps: ["https://vector.dev/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://vector.dev/**"],
  schedule: "at 19:10 on Friday",
  actions: [
    {
      indexName: "timberio_vector",
      pathsToMatch: ["https://vector.dev/docs/**"],
