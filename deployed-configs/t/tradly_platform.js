new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://portal.tradly.app/docs/", "https://portal.tradly.app/"],
  renderJavaScript: false,
  sitemaps: ["https://portal.tradly.app/docs/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://portal.tradly.app/**"],
  schedule: "at 19:40 on Friday",
  actions: [
    {
      indexName: "tradly_platform",
      pathsToMatch: ["https://portal.tradly.app/docs/**"],
