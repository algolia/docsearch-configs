new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://tachiyomi.org/"],
  renderJavaScript: false,
  sitemaps: ["https://tachiyomi.org/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://tachiyomi.org/**"],
  schedule: "at 19:00 on Friday",
  actions: [
    {
      indexName: "tachiyomi",
      pathsToMatch: ["https://tachiyomi.org/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".table-of-contents, .badge";
        $(toRemove).remove();
