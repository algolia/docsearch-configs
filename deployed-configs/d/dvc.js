new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://dvc.org/doc/", "https://dvc.org/"],
  renderJavaScript: true,
  sitemaps: [],
  exclusionPatterns: ["https://dvc.org/doc/get-started/install"],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://dvc.org/**"],
  schedule: "at 15:50 on Tuesday",
  actions: [
    {
      indexName: "dvc",
      pathsToMatch: ["https://dvc.org/doc/**"],
