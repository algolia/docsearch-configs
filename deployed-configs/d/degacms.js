new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://degacms.com/docs/", "https://degacms.com/"],
  renderJavaScript: false,
  sitemaps: ["https://degacms.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://degacms.com/**"],
  schedule: "at 15:00 on Tuesday",
  actions: [
    {
      indexName: "degacms",
      pathsToMatch: ["https://degacms.com/docs/**"],
