new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://devspace.sh/component-chart/docs",
    "https://devspace.sh/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://devspace.sh/component-chart/docssitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://devspace.sh/**"],
  schedule: "at 15:00 on Tuesday",
  actions: [
    {
      indexName: "devspace-component-chart",
      pathsToMatch: ["https://devspace.sh/component-chart/docs**/**"],
