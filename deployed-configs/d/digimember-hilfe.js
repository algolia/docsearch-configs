new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://www.digimember-hilfe.de/docs/",
    "https://www.digimember-hilfe.de/",
    "https://www.digimember-hilfe.de/docs/quick-start-guide",
  ],
  renderJavaScript: false,
  sitemaps: ["https://www.digimember-hilfe.de/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://www.digimember-hilfe.de/**"],
  schedule: "at 15:10 on Tuesday",
  actions: [
    {
      indexName: "digimember-hilfe",
      pathsToMatch: [
        "https://www.digimember-hilfe.de/docs/**",
        "https://www.digimember-hilfe.de/docs/quick-start-guide**/**",
      ],
