new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://docs.deta.sh/docs/", "https://docs.deta.sh/"],
  renderJavaScript: false,
  sitemaps: ["https://docs.deta.sh/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.deta.sh/**"],
  schedule: "at 15:00 on Tuesday",
  actions: [
    {
      indexName: "deta",
      pathsToMatch: ["https://docs.deta.sh/docs/**"],
