new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://docusaurus-powershell.netlify.app/"],
  renderJavaScript: false,
  sitemaps: ["https://docusaurus-powershell.netlify.app/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docusaurus-powershell.netlify.app/**"],
  schedule: "at 15:30 on Tuesday",
  actions: [
    {
      indexName: "docusaurus-powershell",
      pathsToMatch: ["https://docusaurus-powershell.netlify.app/**"],
