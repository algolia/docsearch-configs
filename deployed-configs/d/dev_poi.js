new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://dev.poooi.app/docs/", "https://dev.poooi.app/"],
  renderJavaScript: false,
  sitemaps: ["https://dev.poooi.app/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://dev.poooi.app/**"],
  schedule: "at 15:00 on Tuesday",
  actions: [
    {
      indexName: "dev_poi",
      pathsToMatch: ["https://dev.poooi.app/docs/**"],
