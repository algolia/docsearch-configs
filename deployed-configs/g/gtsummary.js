new Crawler({
  ...
  startUrls: [
    ...
    "http://www.danieldsjoberg.com/",
    "http://www.danieldsjoberg.com/gtsummary/reference",
    "http://www.danieldsjoberg.com/gtsummary/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["http://www.danieldsjoberg.com/gtsummary/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  discoveryPatterns: ["http://www.danieldsjoberg.com/**"],
  schedule: "at 06:40 on Wednesday",
  actions: [
    {
      indexName: "gtsummary",
      pathsToMatch: ["http://www.danieldsjoberg.com/gtsummary/index.html**/**"],
    ...
    {
      indexName: "gtsummary",
      pathsToMatch: ["http://www.danieldsjoberg.com/gtsummary/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "gtsummary",
      pathsToMatch: ["http://www.danieldsjoberg.com/gtsummary/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
