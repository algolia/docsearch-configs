new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://docs.geekbeacon.org/docs/",
    "https://docs.geekbeacon.org/",
    "https://docs.geekbeacon.org/docs/intro/welcome",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.geekbeacon.org/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.geekbeacon.org/**"],
