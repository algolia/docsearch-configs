new Crawler({
  ...
  startUrls: [
    ...
    "https://gganimate.com/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://gganimate.com/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  discoveryPatterns: ["https://gganimate.com/**"],
  schedule: "at 06:10 on Wednesday",
  actions: [
    {
      indexName: "gganimate",
      pathsToMatch: ["https://gganimate.com/index.html**/**"],
    ...
    {
      indexName: "gganimate",
      pathsToMatch: ["https://gganimate.com/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "gganimate",
      pathsToMatch: ["https://gganimate.com/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
