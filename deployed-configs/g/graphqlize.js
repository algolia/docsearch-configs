new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://www.graphqlize.org/docs/",
    "https://www.graphqlize.org/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://www.graphqlize.org/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://www.graphqlize.org/**"],
  schedule: "at 06:40 on Wednesday",
  actions: [
    {
      indexName: "graphqlize",
      pathsToMatch: ["https://www.graphqlize.org/docs/**"],
