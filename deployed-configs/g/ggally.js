new Crawler({
  ...
  startUrls: [
    ...
    "https://ggobi.github.io/",
    "https://ggobi.github.io/ggally/reference",
    "https://ggobi.github.io/ggally/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://ggobi.github.io/ggally/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  discoveryPatterns: ["https://ggobi.github.io/**"],
  schedule: "at 06:10 on Wednesday",
  actions: [
    {
      indexName: "ggally",
      pathsToMatch: ["https://ggobi.github.io/ggally/index.html**/**"],
    ...
    {
      indexName: "ggally",
      pathsToMatch: ["https://ggobi.github.io/ggally/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "ggally",
      pathsToMatch: ["https://ggobi.github.io/ggally/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
