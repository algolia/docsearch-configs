new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "http://www.pivottabler.org.uk/index.html",
    "http://www.pivottabler.org.uk/",
    "http://www.pivottabler.org.uk/reference",
    "http://www.pivottabler.org.uk/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["http://www.pivottabler.org.uk/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  discoveryPatterns: ["http://www.pivottabler.org.uk/**"],
  schedule: "at 00:10 on Friday",
  actions: [
    {
      indexName: "pivottabler",
      pathsToMatch: ["http://www.pivottabler.org.uk/index.html**/**"],
    ...
    {
      indexName: "pivottabler",
      pathsToMatch: ["http://www.pivottabler.org.uk/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "pivottabler",
      pathsToMatch: ["http://www.pivottabler.org.uk/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
