new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://docs.pods.io/"],
  renderJavaScript: false,
  sitemaps: ["https://docs.pods.io/sitemap_index.xml"],
  exclusionPatterns: [
    "**/keyword/**",
    "**/page/**",
    "**/context/**",
    "**/video-types/**",
    "https://docs.pods.io/videos/",
  ],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.pods.io/**"],
  schedule: "at 00:30 on Friday",
  actions: [
    {
      indexName: "pods-framework",
