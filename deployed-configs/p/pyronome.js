new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://help.pyronome.com/"],
  renderJavaScript: false,
  sitemaps: ["https://help.pyronome.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://help.pyronome.com/**"],
  schedule: "at 00:50 on Friday",
  actions: [
    {
      indexName: "pyronome",
      pathsToMatch: ["https://help.pyronome.com/**"],
