new Crawler({
  ...
  startUrls: [
    ...
    "https://pkgdown.r-lib.org/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://pkgdown.r-lib.org/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  discoveryPatterns: ["https://pkgdown.r-lib.org/**"],
  schedule: "at 00:20 on Friday",
  actions: [
    {
      indexName: "pkgdown",
      pathsToMatch: ["https://pkgdown.r-lib.org/index.html**/**"],
    ...
    {
      indexName: "pkgdown",
      pathsToMatch: ["https://pkgdown.r-lib.org/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "pkgdown",
      pathsToMatch: ["https://pkgdown.r-lib.org/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
