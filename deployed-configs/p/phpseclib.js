new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://phpseclib.com/docs/", "https://phpseclib.com/"],
  renderJavaScript: false,
  sitemaps: ["https://phpseclib.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://phpseclib.com/**"],
  schedule: "at 00:10 on Friday",
  actions: [
    {
      indexName: "phpseclib",
      pathsToMatch: ["https://phpseclib.com/docs/**"],
