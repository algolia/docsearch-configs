new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://plausible.io/docs/", "https://plausible.io/"],
  renderJavaScript: false,
  sitemaps: ["https://plausible.io/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://plausible.io/**"],
  schedule: "at 00:20 on Friday",
  actions: [
    {
      indexName: "plausible",
      pathsToMatch: ["https://plausible.io/docs/**"],
