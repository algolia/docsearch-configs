new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://docs.pixielabs.ai/"],
  renderJavaScript: false,
  sitemaps: ["https://docs.pixielabs.ai/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.pixielabs.ai/**"],
  schedule: "at 00:10 on Friday",
  actions: [
    {
      indexName: "pixielabs",
      pathsToMatch: ["https://docs.pixielabs.ai/**"],
