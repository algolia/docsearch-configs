new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://personium.io/docs/", "https://personium.io/"],
  renderJavaScript: false,
  sitemaps: ["https://personium.io/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://personium.io/**"],
  schedule: "at 00:00 on Friday",
  actions: [
    {
      indexName: "personium",
      pathsToMatch: ["https://personium.io/docs/**"],
