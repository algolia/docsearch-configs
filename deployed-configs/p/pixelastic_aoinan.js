new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://projects.pixelastic.com/aoinan/",
    "https://projects.pixelastic.com/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://projects.pixelastic.com/aoinan/sitemap.xml"],
  exclusionPatterns: ["!**/"],
  ...
  actions: [
    {
      indexName: "pixelastic_aoinan",
      pathsToMatch: ["https://projects.pixelastic.com/aoinan/**"],
