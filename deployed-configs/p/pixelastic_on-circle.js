new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://projects.pixelastic.com/on-circle/",
    "https://projects.pixelastic.com/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://projects.pixelastic.com/on-circle/sitemap.xml"],
  exclusionPatterns: ["!**/"],
  ...
  actions: [
    {
      ...
      pathsToMatch: ["https://projects.pixelastic.com/on-circle/**"],
