new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://docs.planetnode.net/"],
  renderJavaScript: false,
  sitemaps: ["https://docs.planetnode.net/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.planetnode.net/**"],
  schedule: "at 00:20 on Friday",
  actions: [
    {
      indexName: "planetnode",
      pathsToMatch: ["https://docs.planetnode.net**/**"],
