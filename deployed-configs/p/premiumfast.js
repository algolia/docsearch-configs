new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://docs.premiumfast.net/"],
  renderJavaScript: false,
  sitemaps: ["https://docs.premiumfast.net/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.premiumfast.net/**"],
  schedule: "at 00:40 on Friday",
  actions: [
    {
      indexName: "premiumfast",
      pathsToMatch: ["https://docs.premiumfast.net/**"],
