new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://prismic.io/docs", "https://prismic.io/"],
  renderJavaScript: false,
  sitemaps: [],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://prismic.io/**"],
  schedule: "at 00:40 on Friday",
  actions: [
    {
      indexName: "prismic",
      pathsToMatch: ["https://prismic.io/docs**/**"],
      recordExtractor: ({ $, helpers }) => {
        return helpers.docsearch({
          recordProps: {
            ...
            lvl0: {
              selectors: "div [class*='CurrentTechnology'] h2",
