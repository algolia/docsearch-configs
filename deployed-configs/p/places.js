  ...
  actions: [
    {
      ...
      recordExtractor: ({ $, helpers }) => {
        return helpers.docsearch({
          recordProps: {
            lvl1: ".documentation-container h2",
            content: ".documentation-container p",
            lvl0: {
              selectors: "h1",
            },
            lvl2: ".documentation-container h3",
            lvl3: ".documentation-container .api-entry",
          },
          indexHeadings: true,
        });
      },
    ...
    {
      indexName: "places",
      pathsToMatch: ["https://community.algolia.com/places/examples.html**/**"],
      recordExtractor: ({ $, helpers }) => {
        return helpers.docsearch({
          recordProps: {
            lvl1: ".documentation-container h2",
