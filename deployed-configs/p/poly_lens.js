new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["http://info.lens.poly.com/"],
  renderJavaScript: false,
  sitemaps: ["http://info.lens.poly.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["http://info.lens.poly.com/**"],
  schedule: "at 00:30 on Friday",
  actions: [
    {
      indexName: "poly_lens",
      pathsToMatch: ["http://info.lens.poly.com/**"],
