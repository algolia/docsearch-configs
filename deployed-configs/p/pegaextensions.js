new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://pegaextensions.netlify.app/docs/",
    "https://pegaextensions.netlify.app/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://pegaextensions.netlify.app/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://pegaextensions.netlify.app/**"],
  schedule: "at 00:00 on Friday",
  actions: [
    {
      indexName: "pegaextensions",
      pathsToMatch: ["https://pegaextensions.netlify.app/docs/**"],
