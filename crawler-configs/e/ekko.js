new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://docs.ekko.chat/docs/",
    "https://docs.ekko.chat/",
    "https://docs.ekko.chat/docs/quick_start/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.ekko.chat/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.ekko.chat/**"],
