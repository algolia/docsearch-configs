new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://docs.egret.com/uieditor/docs",
    "https://docs.egret.com/",
    "https://docs.egret.com/uieditor/docs/uieditor/update/update1100",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.egret.com/uieditor/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.egret.com/**"],
  schedule: "at 20:10 on Tuesday",
  actions: [
    {
      indexName: "egret_uieditor",
      pathsToMatch: [
        "https://docs.egret.com/uieditor/docs**/**",
        "https://docs.egret.com/uieditor/docs/uieditor/update/update1100**/**",
      ],
