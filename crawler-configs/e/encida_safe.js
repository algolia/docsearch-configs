new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://docs.encida.dk/"],
  renderJavaScript: false,
  sitemaps: ["https://docs.encida.dk/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.encida.dk/**"],
  schedule: "at 20:30 on Tuesday",
  actions: [
    {
      indexName: "encida_safe",
      pathsToMatch: ["https://docs.encida.dk/**"],
