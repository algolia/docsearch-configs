new Crawler({
  ...
  startUrls: [
    ...
    "https://docs.energytransitionmodel.com/intro",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.energytransitionmodel.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.energytransitionmodel.com/**"],
