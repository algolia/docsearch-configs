new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://epiforecasts.io/covidregionaldata/index.html",
    "https://epiforecasts.io/",
    "https://epiforecasts.io/covidregionaldata/reference",
    "https://epiforecasts.io/covidregionaldata/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://epiforecasts.io/covidregionaldata/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    ...
    {
      indexName: "epiforecasts",
      pathsToMatch: ["https://epiforecasts.io/covidregionaldata/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
