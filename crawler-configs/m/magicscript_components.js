new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://components.magicscript.org/docs/",
    "https://components.magicscript.org/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://components.magicscript.org/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://components.magicscript.org/**"],
  schedule: "at 10:00 on Thursday",
  actions: [
    {
      indexName: "magicscript_components",
      pathsToMatch: ["https://components.magicscript.org/docs/**"],
