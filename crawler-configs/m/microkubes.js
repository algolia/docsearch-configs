new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://www.microkubes.com/docs/",
    "https://www.microkubes.com/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://www.microkubes.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://www.microkubes.com/**"],
  schedule: "at 10:10 on Thursday",
  actions: [
    {
      indexName: "microkubes",
      pathsToMatch: ["https://www.microkubes.com/docs/**"],
