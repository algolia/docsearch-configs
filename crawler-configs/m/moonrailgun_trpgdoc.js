new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://trpgdoc.moonrailgun.com/docs/",
    "https://trpgdoc.moonrailgun.com/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://trpgdoc.moonrailgun.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://trpgdoc.moonrailgun.com/**"],
  schedule: "at 10:30 on Thursday",
  actions: [
    {
      indexName: "moonrailgun_trpgdoc",
      pathsToMatch: ["https://trpgdoc.moonrailgun.com/docs/**"],
