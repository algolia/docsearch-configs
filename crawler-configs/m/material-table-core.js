new Crawler({
  ...
  sitemaps: ["https://material-table-core.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://material-table-core.com/**"],
  schedule: "at 10:00 on Thursday",
  actions: [
    {
      indexName: "material-table-core",
      pathsToMatch: ["https://material-table-core.com/docs/**"],
