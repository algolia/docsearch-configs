new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://docs.monosync.in/docs/",
    "https://docs.monosync.in/",
    "https://docs.monosync.in/docs/index",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.monosync.in/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.monosync.in/**"],
