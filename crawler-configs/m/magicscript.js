new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://www.magicscript.org/docs/",
    "https://www.magicscript.org/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://www.magicscript.org/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://www.magicscript.org/**"],
  schedule: "at 10:00 on Thursday",
  actions: [
    {
      indexName: "magicscript",
      pathsToMatch: ["https://www.magicscript.org/docs/**"],
