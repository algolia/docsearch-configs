new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://david-barnett.github.io/microViz/index.html",
    "https://david-barnett.github.io/",
    "https://david-barnett.github.io/microViz/reference",
  ...
  discoveryPatterns: ["https://david-barnett.github.io/**"],
  ...
  actions: [
    ...
    {
      indexName: "microViz",
      pathsToMatch: ["https://david-barnett.github.io/microViz/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "microViz",
      pathsToMatch: ["https://david-barnett.github.io/microViz/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
