new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://learning-notes.mistermicheels.com/"],
  renderJavaScript: false,
  sitemaps: ["https://learning-notes.mistermicheels.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://learning-notes.mistermicheels.com/**"],
  schedule: "at 10:10 on Thursday",
  actions: [
    {
      indexName: "mistermicheels_learning-notes",
      pathsToMatch: ["https://learning-notes.mistermicheels.com/**"],
