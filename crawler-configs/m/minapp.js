new Crawler({
  ...
  startUrls: [
    ...
    "https://qiu8310.github.io/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://qiu8310.github.io/minapp/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://qiu8310.github.io/**"],
  schedule: "at 10:10 on Thursday",
  actions: [
    {
      indexName: "minapp",
      pathsToMatch: ["https://qiu8310.github.io/minapp/**"],
