new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://docs.journal-theme.com/docs/",
    "https://docs.journal-theme.com/",
    "https://docs.journal-theme.com/docs/general",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.journal-theme.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.journal-theme.com/**"],
  schedule: "at 20:30 on Wednesday",
  actions: [
    {
      indexName: "journal-theme",
      pathsToMatch: [
        "https://docs.journal-theme.com/docs/**",
        "https://docs.journal-theme.com/docs/general**/**",
      ],
