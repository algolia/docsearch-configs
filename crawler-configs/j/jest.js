new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://archive.jestjs.io/"],
  renderJavaScript: false,
  sitemaps: ["https://archive.jestjs.io/sitemap.xml"],
  exclusionPatterns: [
    "**/help**",
    "**/help**/**",
    "**/videos**",
  ...
  discoveryPatterns: ["https://archive.jestjs.io/**"],
  schedule: "at 20:00 on Wednesday",
  actions: [
    {
      indexName: "jest",
      pathsToMatch: ["https://archive.jestjs.io/**"],
