new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://jobjects.com/docs/", "https://jobjects.com/"],
  renderJavaScript: false,
  sitemaps: ["https://jobjects.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://jobjects.com/**"],
  schedule: "at 20:30 on Wednesday",
  actions: [
    {
      indexName: "jobjects",
      pathsToMatch: ["https://jobjects.com/docs/**"],
