new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://docscegekadsa.z6.web.core.windows.net/"],
  renderJavaScript: false,
  sitemaps: [],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docscegekadsa.z6.web.core.windows.net/**"],
  schedule: "at 15:50 on Tuesday",
  actions: [
    {
      indexName: "dynamics-empire",
      pathsToMatch: ["https://docscegekadsa.z6.web.core.windows.net/**"],
