new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "http://developmentseed.org/scoreboard",
    "http://developmentseed.org/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://developmentseed.org/scoreboard/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["http://developmentseed.org/**"],
  schedule: "at 15:00 on Tuesday",
  actions: [
    {
      indexName: "developmentseed_scoreboard",
      pathsToMatch: ["http://developmentseed.org/scoreboard**/**"],
