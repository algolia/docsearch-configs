new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://developer.smash.gg/"],
  renderJavaScript: false,
  sitemaps: ["https://developer.smash.gg/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://developer.smash.gg/**"],
  schedule: "at 15:00 on Tuesday",
  actions: [
    {
      indexName: "developer-portal",
      pathsToMatch: ["https://developer.smash.gg/**"],
