new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://www.data42.cn/dedrr/clinicalsense",
    "https://www.data42.cn/",
  ],
  ...
  discoveryPatterns: ["https://www.data42.cn/**"],
  schedule: "at 15:00 on Tuesday",
  actions: [
    {
      indexName: "dedrr_clinicalsense",
      pathsToMatch: ["https://www.data42.cn/dedrr/clinicalsense**/**"],
