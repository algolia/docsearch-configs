new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://support.doorknockerpal.com/docs/",
    "https://support.doorknockerpal.com/",
    "https://support.doorknockerpal.com/docs/add-door.html",
  ],
  renderJavaScript: false,
  sitemaps: [],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://support.doorknockerpal.com/**"],
  schedule: "at 15:30 on Tuesday",
  actions: [
    {
      indexName: "doorknockerpal",
      pathsToMatch: [
        "https://support.doorknockerpal.com/docs/**",
        "https://support.doorknockerpal.com/docs/add-door.html**/**",
      ],
