new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://bcdocs.xpxsirius.io/docs/",
    "https://bcdocs.xpxsirius.io/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://bcdocs.xpxsirius.io/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://bcdocs.xpxsirius.io/**"],
  schedule: "at 14:30 on Saturday",
  actions: [
    {
      indexName: "xpxsirius_proximax",
      pathsToMatch: ["https://bcdocs.xpxsirius.io/docs/**"],
