new Crawler({
  ...
  sitemaps: ["https://www.thethingsindustries.com/docssitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://www.thethingsindustries.com/**"],
  schedule: "at 19:10 on Friday",
  actions: [
    {
      indexName: "thethingsstack",
      pathsToMatch: ["https://www.thethingsindustries.com/docs/**"],
