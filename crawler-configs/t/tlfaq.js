new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["http://tlfaq.s3-website-us-west-2.amazonaws.com/"],
  renderJavaScript: false,
  sitemaps: [],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["http://tlfaq.s3-website-us-west-2.amazonaws.com/**"],
  schedule: "at 19:20 on Friday",
  actions: [
    {
      indexName: "tlfaq",
      pathsToMatch: ["http://tlfaq.s3-website-us-west-2.amazonaws.com/**"],
