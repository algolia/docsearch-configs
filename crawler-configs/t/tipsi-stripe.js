new Crawler({
  ...
  startUrls: [
    ...
    "https://tipsi.github.io/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://tipsi.github.io/tipsi-stripe/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://tipsi.github.io/**"],
  schedule: "at 19:10 on Friday",
  actions: [
    {
      indexName: "tipsi-stripe",
      pathsToMatch: ["https://tipsi.github.io/tipsi-stripe/**"],
