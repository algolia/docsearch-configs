new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://docs.trefle.io/docs/", "https://docs.trefle.io/"],
  renderJavaScript: false,
  sitemaps: ["https://docs.trefle.io/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.trefle.io/**"],
  schedule: "at 19:40 on Friday",
  actions: [
    {
      indexName: "trefle",
      pathsToMatch: ["https://docs.trefle.io/docs/**"],
