new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://typehero.org/type-route/docs/",
    "https://typehero.org/",
    "https://typehero.org/type-route/docs/introduction/getting-started",
  ],
  renderJavaScript: false,
  sitemaps: ["https://typehero.org/type-route/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://typehero.org/**"],
