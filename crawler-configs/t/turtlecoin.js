new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://docs.turtlecoin.lol/"],
  renderJavaScript: false,
  sitemaps: ["https://docs.turtlecoin.lol/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.turtlecoin.lol/**"],
  schedule: "at 19:40 on Friday",
  actions: [
    {
      indexName: "turtlecoin",
      pathsToMatch: ["https://docs.turtlecoin.lol**/**"],
