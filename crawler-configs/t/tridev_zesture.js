new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://docs.zesture.app/docs/", "https://docs.zesture.app/"],
  renderJavaScript: false,
  sitemaps: ["https://docs.zesture.app/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.zesture.app/**"],
  schedule: "at 19:40 on Friday",
  actions: [
    {
      indexName: "tridev_zesture",
      pathsToMatch: ["https://docs.zesture.app/docs/**"],
