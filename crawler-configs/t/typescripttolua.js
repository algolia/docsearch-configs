new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://typescripttolua.github.io/"],
  renderJavaScript: false,
  sitemaps: ["https://typescripttolua.github.io/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://typescripttolua.github.io/**"],
  schedule: "at 19:50 on Friday",
  actions: [
    {
      indexName: "typescripttolua",
      pathsToMatch: ["https://typescripttolua.github.io/**"],
