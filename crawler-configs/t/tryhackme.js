new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://docs.tryhackme.com/docs/",
    "https://docs.tryhackme.com/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.tryhackme.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.tryhackme.com/**"],
  schedule: "at 19:40 on Friday",
  actions: [
    {
      indexName: "tryhackme",
      pathsToMatch: ["https://docs.tryhackme.com/docs/**"],
