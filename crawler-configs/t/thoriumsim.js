new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://thoriumsim.com/docs/", "https://thoriumsim.com/"],
  renderJavaScript: false,
  sitemaps: ["https://thoriumsim.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://thoriumsim.com/**"],
  schedule: "at 19:10 on Friday",
  actions: [
    {
      indexName: "thoriumsim",
      pathsToMatch: ["https://thoriumsim.com/docs/**"],
