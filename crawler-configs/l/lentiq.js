new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://lentiq.com/docs", "https://lentiq.com/"],
  renderJavaScript: false,
  sitemaps: ["https://lentiq.com/docs/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://lentiq.com/**"],
  schedule: "at 05:00 on Thursday",
  actions: [
    {
      indexName: "lentiq",
      pathsToMatch: ["https://lentiq.com/docs**/**"],
