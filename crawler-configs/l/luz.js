new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://mlverse.github.io/luz/index.html",
    "https://mlverse.github.io/",
    "https://mlverse.github.io/luz/reference",
    "https://mlverse.github.io/luz/articles",
  ],
  ...
  discoveryPatterns: ["https://mlverse.github.io/**"],
  schedule: "at 05:40 on Thursday",
  actions: [
    {
      indexName: "luz",
      pathsToMatch: ["https://mlverse.github.io/luz/index.html**/**"],
    ...
    {
      indexName: "luz",
      pathsToMatch: ["https://mlverse.github.io/luz/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "luz",
      pathsToMatch: ["https://mlverse.github.io/luz/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
