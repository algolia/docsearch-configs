new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://help.lords-bot.com/docs/",
    "https://help.lords-bot.com/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://help.lords-bot.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://help.lords-bot.com/**"],
  schedule: "at 05:30 on Thursday",
  actions: [
    {
      indexName: "lords-bot",
      pathsToMatch: ["https://help.lords-bot.com/docs/**"],
