new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://docs.larapass.net/"],
  renderJavaScript: false,
  sitemaps: ["https://docs.larapass.net/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.larapass.net/**"],
  schedule: "at 05:00 on Thursday",
  actions: [
    {
      indexName: "larapass",
      pathsToMatch: ["https://docs.larapass.net**/**"],
