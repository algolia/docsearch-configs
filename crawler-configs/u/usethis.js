new Crawler({
  ...
  startUrls: [
    ...
    "https://usethis.r-lib.org/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://usethis.r-lib.org/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  discoveryPatterns: ["https://usethis.r-lib.org/**"],
  schedule: "at 00:40 on Saturday",
  actions: [
    {
      indexName: "usethis",
      pathsToMatch: ["https://usethis.r-lib.org/index.html**/**"],
        ...
        return helpers.docsearch({
          recordProps: {
            ...
            lvl0: {
              ...
              defaultValue: "usethis Home page",
            },
            lvl2: ".contents h3",
    ...
    {
      indexName: "usethis",
      pathsToMatch: ["https://usethis.r-lib.org/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "usethis",
      pathsToMatch: ["https://usethis.r-lib.org/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
