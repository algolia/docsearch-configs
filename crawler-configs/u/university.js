new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "http://university.cactusthemes.com/doc/",
    "http://university.cactusthemes.com/",
  ],
  renderJavaScript: false,
  sitemaps: [],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["http://university.cactusthemes.com/**"],
  schedule: "at 00:30 on Saturday",
  actions: [
    {
      indexName: "university",
      pathsToMatch: ["http://university.cactusthemes.com/doc/**"],
