new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://fadevvppstoredev01.z33.web.core.windows.net/"],
  renderJavaScript: false,
  sitemaps: ["https://fadevvppstoredev01.z33.web.core.windows.net/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://fadevvppstoredev01.z33.web.core.windows.net/**"],
  schedule: "at 05:10 on Saturday",
  actions: [
    {
      indexName: "vixel",
      pathsToMatch: ["https://fadevvppstoredev01.z33.web.core.windows.net/**"],
