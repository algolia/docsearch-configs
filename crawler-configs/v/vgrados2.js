new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://vgrados2.github.io/personal-docusaurus/docs/",
    "https://vgrados2.github.io/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://vgrados2.github.io/personal-docusaurus/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://vgrados2.github.io/**"],
  schedule: "at 05:10 on Saturday",
  actions: [
    {
      indexName: "vgrados2",
      pathsToMatch: ["https://vgrados2.github.io/personal-docusaurus/docs/**"],
