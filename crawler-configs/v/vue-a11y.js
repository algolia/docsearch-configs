new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://vue-a11y.com/"],
  renderJavaScript: false,
  sitemaps: ["https://vue-a11y.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://vue-a11y.com/**"],
  schedule: "at 05:40 on Saturday",
  actions: [
    {
      indexName: "vue-a11y",
      pathsToMatch: ["https://vue-a11y.com/**"],
      recordExtractor: ({ $, helpers }) => {
        return helpers.docsearch({
          recordProps: {
            ...
            lvl0: {
              selectors: ".sidebar .sidebar__title-list--active",
            },
