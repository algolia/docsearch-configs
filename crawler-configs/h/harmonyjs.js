new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["http://harmonyjs.io/docs/", "http://harmonyjs.io/"],
  renderJavaScript: false,
  sitemaps: ["http://harmonyjs.io/docs/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["http://harmonyjs.io/**"],
  schedule: "at 10:00 on Wednesday",
  actions: [
    {
      indexName: "harmonyjs",
      pathsToMatch: ["http://harmonyjs.io/docs/**"],
