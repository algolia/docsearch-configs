new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://hasura.io/docs/1.0/",
    "https://hasura.io/",
    "https://hasura.io/docs/1.0/graphql/manual/index.html",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.hasura.io/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://hasura.io/**"],
      ...
      recordExtractor: ({ $, helpers }) => {
        ...
        return helpers.docsearch({
          recordProps: {
            ...
            content:
              "#docs-content p, #docs-content li, #docs-content table, #docs-content pre",
            lvl0: {
