new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["http://docs.holibob.tech/"],
  renderJavaScript: false,
  sitemaps: ["http://docs.holibob.tech/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["http://docs.holibob.tech/**"],
  schedule: "at 10:30 on Wednesday",
  actions: [
    {
      indexName: "holibob",
      pathsToMatch: ["http://docs.holibob.tech/**"],
