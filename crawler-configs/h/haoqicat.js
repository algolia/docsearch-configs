new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://book.haoqicat.com/"],
  renderJavaScript: false,
  sitemaps: [],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://book.haoqicat.com/**"],
  schedule: "at 10:00 on Wednesday",
  actions: [
    {
      indexName: "haoqicat",
      pathsToMatch: ["https://book.haoqicat.com/**"],
      recordExtractor: ({ $, helpers }) => {
        return helpers.docsearch({
          recordProps: {
            ...
            lvl0: {
              selectors: ".docSearch-content div:first-child",
            },
