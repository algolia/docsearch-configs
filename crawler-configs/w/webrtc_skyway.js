new Crawler({
  ...
  actions: [
    {
      indexName: "webrtc_skyway",
      pathsToMatch: ["https://webrtc.ecl.ntt.com/**"],
      recordExtractor: ({ $, helpers }) => {
        ...
        return helpers.docsearch({
          recordProps: {
            ...
            content:
              ".theme-default-content p, .theme-default-content li, .theme-default-content div, .theme-default-content table",
            lvl0: {
