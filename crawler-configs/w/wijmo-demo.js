new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://demo.grapecity.com/wijmo/docs/",
    "https://demo.grapecity.com/",
    "https://demo.grapecity.com/wijmo/demos/",
  ],
  renderJavaScript: false,
  sitemaps: [
    "https://demo.grapecity.com/wijmo/docs/sitemap.xml",
    "https://demo.grapecity.com/wijmo/demos/resource/sitemap.xml",
  ],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://demo.grapecity.com/**"],
  schedule: "at 10:10 on Saturday",
  actions: [
    {
      indexName: "wijmo-demo",
      pathsToMatch: ["https://demo.grapecity.com/wijmo/docs/**"],
    ...
    {
      indexName: "wijmo-demo",
      pathsToMatch: ["https://demo.grapecity.com/wijmo/demos/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".hash-link";
        $(toRemove).remove();
