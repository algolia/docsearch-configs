new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://winternebs.github.io/TETRIS-FAQ/",
    "https://winternebs.github.io/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://winternebs.github.io/TETRIS-FAQ/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://winternebs.github.io/**"],
  schedule: "at 10:10 on Saturday",
  actions: [
    {
      indexName: "winternebs_tetris-faq",
      pathsToMatch: ["https://winternebs.github.io/TETRIS-FAQ/**"],
