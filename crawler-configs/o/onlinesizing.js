new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://docs.onlinesizing.bike/docs/",
    "https://docs.onlinesizing.bike/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.onlinesizing.bike/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.onlinesizing.bike/**"],
  schedule: "at 20:30 on Thursday",
  actions: [
    {
      indexName: "onlinesizing",
      pathsToMatch: ["https://docs.onlinesizing.bike/docs/**"],
