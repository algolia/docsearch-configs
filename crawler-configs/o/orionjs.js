new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://orionjs.com/docs/", "https://orionjs.com/"],
  renderJavaScript: false,
  sitemaps: ["https://orionjs.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://orionjs.com/**"],
  schedule: "at 20:40 on Thursday",
  actions: [
    {
      indexName: "orionjs",
      pathsToMatch: ["https://orionjs.com/docs/**"],
