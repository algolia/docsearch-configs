new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://openeew.com/docs/", "https://openeew.com/"],
  renderJavaScript: false,
  sitemaps: ["https://openeew.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://openeew.com/**"],
  schedule: "at 20:30 on Thursday",
  actions: [
    {
      indexName: "openeew",
      pathsToMatch: ["https://openeew.com/docs/**"],
