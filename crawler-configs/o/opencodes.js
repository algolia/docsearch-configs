new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://opencodes.netlify.app/docs/",
    "https://opencodes.netlify.app/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://opencodes.netlify.app/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://opencodes.netlify.app/**"],
  schedule: "at 20:30 on Thursday",
  actions: [
    {
      indexName: "opencodes",
      pathsToMatch: ["https://opencodes.netlify.app/docs/**"],
