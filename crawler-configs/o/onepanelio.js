new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://docs.onepanel.ai/"],
  renderJavaScript: false,
  sitemaps: ["https://docs.onepanel.ai/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.onepanel.ai/**"],
  schedule: "at 20:30 on Thursday",
  actions: [
    {
      indexName: "onepanelio",
      pathsToMatch: ["https://docs.onepanel.ai/**"],
