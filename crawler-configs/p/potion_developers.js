new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://developers.potion.social/docs/",
    "https://developers.potion.social/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://developers.potion.social/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://developers.potion.social/**"],
  schedule: "at 00:30 on Friday",
  actions: [
    {
      indexName: "potion_developers",
      pathsToMatch: ["https://developers.potion.social/docs/**"],
