new Crawler({
  ...
  startUrls: [
    ...
    "http://gomoob.github.io/",
  ],
  renderJavaScript: false,
  sitemaps: [],
  exclusionPatterns: ["**/**phpdocumentor**", "**/**phpdocumentor**/**"],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["http://gomoob.github.io/**"],
  schedule: "at 00:10 on Friday",
  actions: [
    {
      indexName: "php-pushwoosh",
      pathsToMatch: ["http://gomoob.github.io/php-pushwoosh/**"],
