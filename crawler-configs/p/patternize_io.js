new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://patternize.github.io/docs/",
    "https://patternize.github.io/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://patternize.github.io/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://patternize.github.io/**"],
  schedule: "at 00:00 on Friday",
  actions: [
    {
      indexName: "patternize_io",
      pathsToMatch: ["https://patternize.github.io/docs/**"],
