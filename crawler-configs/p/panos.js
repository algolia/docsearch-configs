new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://panos.pan.dev/docs/", "https://panos.pan.dev/"],
  renderJavaScript: false,
  sitemaps: ["https://panos.pan.dev/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://panos.pan.dev/**"],
  schedule: "at 00:00 on Friday",
  actions: [
    {
      indexName: "panos",
      pathsToMatch: ["https://panos.pan.dev/docs/**"],
