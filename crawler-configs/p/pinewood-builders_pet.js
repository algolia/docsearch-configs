new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://pet.pinewood-builders.com/"],
  renderJavaScript: false,
  sitemaps: [],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://pet.pinewood-builders.com/**"],
  schedule: "at 00:10 on Friday",
  actions: [
    {
      indexName: "pinewood-builders_pet",
      pathsToMatch: ["https://pet.pinewood-builders.com/**"],
