new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://docs.pixelmedics.de/"],
  renderJavaScript: false,
  sitemaps: ["https://docs.pixelmedics.de/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.pixelmedics.de/**"],
  schedule: "at 00:10 on Friday",
  actions: [
    {
      indexName: "pixelmedics",
      pathsToMatch: ["https://docs.pixelmedics.de/**"],
