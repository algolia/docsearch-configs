new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://tms.pinewood-builders.com/"],
  renderJavaScript: false,
  sitemaps: [],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://tms.pinewood-builders.com/**"],
  schedule: "at 00:10 on Friday",
  actions: [
    {
      indexName: "pinewood-builders_tms",
      pathsToMatch: ["https://tms.pinewood-builders.com/**"],
