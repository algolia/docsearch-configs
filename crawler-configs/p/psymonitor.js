new Crawler({
  ...
  startUrls: [
    ...
    "https://itamarcaspi.github.io/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://itamarcaspi.github.io/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://itamarcaspi.github.io/**"],
  schedule: "at 00:40 on Friday",
  actions: [
    {
      indexName: "psymonitor",
      pathsToMatch: ["https://itamarcaspi.github.io/psymonitor/**"],
