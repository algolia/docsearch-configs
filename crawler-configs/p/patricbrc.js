new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://docs.patricbrc.org/"],
  renderJavaScript: false,
  sitemaps: ["https://docs.patricbrc.org/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.patricbrc.org/**"],
  schedule: "at 00:00 on Friday",
  actions: [
    {
      indexName: "patricbrc",
      pathsToMatch: ["https://docs.patricbrc.org/**"],
