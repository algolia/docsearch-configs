new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://facebookincubator.github.io/profilo/",
    "https://facebookincubator.github.io/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://facebookincubator.github.io/profilo/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://facebookincubator.github.io/**"],
  schedule: "at 00:40 on Friday",
  actions: [
    {
      indexName: "profilo",
      pathsToMatch: ["https://facebookincubator.github.io/profilo/**"],
