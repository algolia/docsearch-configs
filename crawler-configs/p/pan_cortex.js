new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://cortex.pan.dev/docs/", "https://cortex.pan.dev/"],
  renderJavaScript: false,
  sitemaps: ["https://cortex.pan.dev/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://cortex.pan.dev/**"],
  schedule: "at 00:00 on Friday",
  actions: [
    {
      indexName: "pan_cortex",
      pathsToMatch: ["https://cortex.pan.dev/docs/**"],
