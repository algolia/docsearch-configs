new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://docs.fpt.ai/docs/", "https://docs.fpt.ai/"],
  renderJavaScript: false,
  sitemaps: ["https://docs.fpt.ai/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.fpt.ai/**"],
  schedule: "at 01:30 on Wednesday",
  actions: [
    {
      indexName: "fpt",
      pathsToMatch: ["https://docs.fpt.ai/docs/**"],
