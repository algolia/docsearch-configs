new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://docs.fxstreet.com/"],
  renderJavaScript: false,
  sitemaps: ["https://docs.fxstreet.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.fxstreet.com/**"],
  schedule: "at 01:50 on Wednesday",
  actions: [
    {
      indexName: "fxstreet",
      pathsToMatch: ["https://docs.fxstreet.com/**"],
