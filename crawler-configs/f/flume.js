new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://flume.dev/docs/", "https://flume.dev/"],
  renderJavaScript: false,
  sitemaps: ["https://flume.dev/docs/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://flume.dev/**"],
  schedule: "at 01:20 on Wednesday",
  actions: [
    {
      indexName: "flume",
      pathsToMatch: ["https://flume.dev/docs/**"],
