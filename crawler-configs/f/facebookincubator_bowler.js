new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://pybowler.io/docs/", "https://pybowler.io/"],
  renderJavaScript: false,
  sitemaps: ["https://pybowler.io/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://pybowler.io/**"],
  schedule: "at 01:00 on Wednesday",
  actions: [
    {
      indexName: "facebookincubator_bowler",
      pathsToMatch: ["https://pybowler.io/docs/**"],
