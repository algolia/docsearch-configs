new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://zen-docs.netlify.app/docs/",
    "https://zen-docs.netlify.app/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://zen-docs.netlify.app/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://zen-docs.netlify.app/**"],
  schedule: "at 01:40 on Wednesday",
  actions: [
    {
      indexName: "fristonio_zen",
      pathsToMatch: ["https://zen-docs.netlify.app/docs/**"],
