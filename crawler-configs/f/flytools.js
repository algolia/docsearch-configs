new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://docs.flytools.de/docs/", "https://docs.flytools.de/"],
  renderJavaScript: false,
  sitemaps: ["https://docs.flytools.de/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.flytools.de/**"],
  schedule: "at 01:20 on Wednesday",
  actions: [
    {
      indexName: "flytools",
      pathsToMatch: ["https://docs.flytools.de/docs/**"],
