new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://docs.flowcms.xyz/docs/",
    "https://docs.flowcms.xyz/",
    "https://docs.flowcms.xyz/docs/getting-started/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.flowcms.xyz/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.flowcms.xyz/**"],
