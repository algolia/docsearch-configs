new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://developers.nexla.com/docs/",
    "https://developers.nexla.com/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://developers.nexla.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://developers.nexla.com/**"],
  schedule: "at 15:00 on Thursday",
  actions: [
    {
      indexName: "nexla_developers",
      pathsToMatch: ["https://developers.nexla.com/docs/**"],
