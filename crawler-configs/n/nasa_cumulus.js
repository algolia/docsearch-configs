new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://nasa.github.io/cumulus/", "https://nasa.github.io/"],
  renderJavaScript: false,
  sitemaps: ["https://nasa.github.io/cumulus/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://nasa.github.io/**"],
  schedule: "at 15:00 on Thursday",
  actions: [
    {
      indexName: "nasa_cumulus",
      pathsToMatch: ["https://nasa.github.io/cumulus/**"],
