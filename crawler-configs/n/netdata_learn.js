new Crawler({
  ...
  sitemaps: ["https://learn.netdata.cloud/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://learn.netdata.cloud/**"],
  schedule: "at 15:00 on Thursday",
  actions: [
    {
      indexName: "netdata_learn",
      pathsToMatch: ["https://learn.netdata.cloud/docs/**"],
      recordExtractor: ({ $, helpers }) => {
        ...
        return helpers.docsearch({
          recordProps: {
            ...
            content:
              "[class^='docItemContainer_'] p, [class^='docItemContainer_'] li, [class^='docItemContainer_'] table td",
            lvl0: {
