new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://netdaemon.xyz/docs/",
    "https://netdaemon.xyz/",
    "https://netdaemon.xyz/docs/index",
  ],
  renderJavaScript: false,
  sitemaps: ["https://netdaemon.xyz/sitemap.xml"],
  exclusionPatterns: [
    "https://netdaemon.xyz/docs/api/v1**",
    "https://netdaemon.xyz/docs/api/v1**/**",
  ],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://netdaemon.xyz/**"],
