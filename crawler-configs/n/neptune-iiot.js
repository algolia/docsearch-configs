new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://docs.neptune-iiot.net/docs/",
    "https://docs.neptune-iiot.net/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.neptune-iiot.net/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.neptune-iiot.net/**"],
  schedule: "at 15:00 on Thursday",
  actions: [
    {
      indexName: "neptune-iiot",
      pathsToMatch: ["https://docs.neptune-iiot.net/docs/**"],
