new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://nus-cs2103-ay2122s1.github.io/website/schedule/",
    "https://nus-cs2103-ay2122s1.github.io/",
    "https://nus-cs2103-ay2122s1.github.io/website/admin/",
    "https://nus-cs2103-ay2122s1.github.io/website/se-book-adapted/",
    "https://nus-cs2103-ay2122s1.github.io/website/",
  ],
  ...
  discoveryPatterns: ["https://nus-cs2103-ay2122s1.github.io/**"],
  ...
  actions: [
    ...
    {
      indexName: "nus-cs2103-ay1920s1",
      pathsToMatch: ["https://nus-cs2103-ay2122s1.github.io/website/admin/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".algolia-no-index, [id$='-toc'], #toc, .alert";
        $(toRemove).remove();
