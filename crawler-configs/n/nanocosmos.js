new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://docs.nanocosmos.de/docs/",
    "https://docs.nanocosmos.de/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.nanocosmos.de/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.nanocosmos.de/**"],
  schedule: "at 15:00 on Thursday",
  actions: [
    {
      indexName: "nanocosmos",
      pathsToMatch: ["https://docs.nanocosmos.de/docs/**"],
