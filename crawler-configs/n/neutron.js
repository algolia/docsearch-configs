new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://www.neutronjs.com/"],
  renderJavaScript: false,
  sitemaps: ["https://www.neutronjs.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://www.neutronjs.com/**"],
  schedule: "at 15:00 on Thursday",
  actions: [
    {
      indexName: "neutron",
      pathsToMatch: ["https://www.neutronjs.com/**"],
