new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://qantev.github.io/user-knowledgebase/docs/",
    "https://qantev.github.io/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://qantev.github.io/user-knowledgebase/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://qantev.github.io/**"],
  schedule: "at 05:00 on Friday",
  actions: [
    {
      indexName: "qantev_user-knowledgebase",
      pathsToMatch: ["https://qantev.github.io/user-knowledgebase/docs/**"],
