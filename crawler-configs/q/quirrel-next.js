new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://docs.quirrel.dev/"],
  renderJavaScript: false,
  sitemaps: ["https://docs.quirrel.dev/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.quirrel.dev/**"],
  schedule: "at 05:40 on Friday",
  actions: [
    {
      indexName: "quirrel-next",
      pathsToMatch: ["https://docs.quirrel.dev/**"],
