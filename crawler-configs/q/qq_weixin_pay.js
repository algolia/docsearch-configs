new Crawler({
  ...
  actions: [
    {
      indexName: "qq_weixin_pay",
      pathsToMatch: ["https://pay.weixin.qq.com/**"],
      recordExtractor: ({ $, helpers }) => {
        return helpers.docsearch({
          recordProps: {
            lvl1: "",
            content: ".doc-main p, .content-hd p, .doc-main li, .content-hd li",
            lvl0: {
              selectors:
                "div.bread-crumb.title-top > a:nth-child(2), p.sidebar-heading.open",
