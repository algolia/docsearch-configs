new Crawler({
  ...
  discoveryPatterns: ["https://quilljs.com/**", "http://quilljs.com/**"],
  schedule: "at 05:40 on Friday",
  actions: [
    {
      indexName: "quilljs",
      pathsToMatch: ["https://quilljs.com/guides/**"],
    ...
    {
      indexName: "quilljs",
      pathsToMatch: ["https://quilljs.com/guides/why-quill/**"],
      recordExtractor: ({ $, helpers }) => {
        return helpers.docsearch({
          recordProps: {
            lvl1: "#content-container h1",
