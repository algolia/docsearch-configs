new Crawler({
  ...
  startUrls: [
    ...
    "https://developer.24sevenoffice.com/",
  ],
  renderJavaScript: false,
  sitemaps: [],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://developer.24sevenoffice.com/**"],
  schedule: "at 06:20 on Monday",
  actions: [
    {
      indexName: "24sevenoffice",
      pathsToMatch: ["https://developer.24sevenoffice.com/docs/**"],
