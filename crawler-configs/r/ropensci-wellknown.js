new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://docs.ropensci.org/wellknown/index.html",
    "https://docs.ropensci.org/",
    "https://docs.ropensci.org/wellknown/reference",
    "https://docs.ropensci.org/wellknown/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.ropensci.org/wellknown/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      ...
      pathsToMatch: ["https://docs.ropensci.org/wellknown/index.html**/**"],
    ...
    {
      indexName: "ropensci-wellknown",
      pathsToMatch: ["https://docs.ropensci.org/wellknown/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "ropensci-wellknown",
      pathsToMatch: ["https://docs.ropensci.org/wellknown/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
