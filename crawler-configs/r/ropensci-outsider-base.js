new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://docs.ropensci.org/outsider.base/index.html",
    "https://docs.ropensci.org/",
    "https://docs.ropensci.org/outsider.base/reference",
    "https://docs.ropensci.org/outsider.base/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.ropensci.org/outsider.base/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      ...
      pathsToMatch: ["https://docs.ropensci.org/outsider.base/index.html**/**"],
    ...
    {
      indexName: "ropensci-outsider-base",
      pathsToMatch: ["https://docs.ropensci.org/outsider.base/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "ropensci-outsider-base",
      pathsToMatch: ["https://docs.ropensci.org/outsider.base/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
