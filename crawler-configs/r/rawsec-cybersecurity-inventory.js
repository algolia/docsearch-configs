new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://inventory.rawsec.ml/docs/",
    "https://inventory.rawsec.ml/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://inventory.rawsec.ml/docs/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://inventory.rawsec.ml/**"],
  schedule: "at 10:00 on Friday",
  actions: [
    {
      indexName: "rawsec-cybersecurity-inventory",
      pathsToMatch: ["https://inventory.rawsec.ml/docs/**"],
