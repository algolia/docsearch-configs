new Crawler({
  ...
  startUrls: [
    ...
    "https://docs.ropensci.org/visdat/reference",
    "https://docs.ropensci.org/visdat/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.ropensci.org/visdat/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      indexName: "ropensci-visdat",
      pathsToMatch: ["https://docs.ropensci.org/visdat/index.html**/**"],
    ...
    {
      indexName: "ropensci-visdat",
      pathsToMatch: ["https://docs.ropensci.org/visdat/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "ropensci-visdat",
      pathsToMatch: ["https://docs.ropensci.org/visdat/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
