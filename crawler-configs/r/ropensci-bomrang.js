new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://docs.ropensci.org/bomrang/index.html",
    "https://docs.ropensci.org/",
    "https://docs.ropensci.org/bomrang/reference",
    "https://docs.ropensci.org/bomrang/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.ropensci.org/bomrang/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      ...
      pathsToMatch: ["https://docs.ropensci.org/bomrang/index.html**/**"],
    ...
    {
      indexName: "ropensci-bomrang",
      pathsToMatch: ["https://docs.ropensci.org/bomrang/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "ropensci-bomrang",
      pathsToMatch: ["https://docs.ropensci.org/bomrang/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
