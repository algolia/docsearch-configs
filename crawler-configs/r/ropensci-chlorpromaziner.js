new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://docs.ropensci.org/chlorpromazineR/index.html",
    "https://docs.ropensci.org/",
    "https://docs.ropensci.org/chlorpromazineR/reference",
    "https://docs.ropensci.org/chlorpromazineR/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.ropensci.org/chlorpromazineR/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      indexName: "ropensci-chlorpromaziner",
      pathsToMatch: [
        "https://docs.ropensci.org/chlorpromazineR/index.html**/**",
      ],
    ...
    {
      indexName: "ropensci-chlorpromaziner",
      pathsToMatch: ["https://docs.ropensci.org/chlorpromazineR/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
