new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://docs.ropensci.org/rnpn/index.html",
    "https://docs.ropensci.org/",
    "https://docs.ropensci.org/rnpn/reference",
    "https://docs.ropensci.org/rnpn/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.ropensci.org/rnpn/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      ...
      pathsToMatch: ["https://docs.ropensci.org/rnpn/index.html**/**"],
    ...
    {
      indexName: "ropensci-rnpn",
      pathsToMatch: ["https://docs.ropensci.org/rnpn/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "ropensci-rnpn",
      pathsToMatch: ["https://docs.ropensci.org/rnpn/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
