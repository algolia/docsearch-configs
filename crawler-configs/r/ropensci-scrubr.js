new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://docs.ropensci.org/scrubr/index.html",
    "https://docs.ropensci.org/",
    "https://docs.ropensci.org/scrubr/reference",
    "https://docs.ropensci.org/scrubr/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.ropensci.org/scrubr/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      ...
      pathsToMatch: ["https://docs.ropensci.org/scrubr/index.html**/**"],
    ...
    {
      indexName: "ropensci-scrubr",
      pathsToMatch: ["https://docs.ropensci.org/scrubr/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "ropensci-scrubr",
      pathsToMatch: ["https://docs.ropensci.org/scrubr/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
