new Crawler({
  ...
  startUrls: [
    ...
    "https://docs.ropensci.org/pathviewr/reference",
    "https://docs.ropensci.org/pathviewr/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.ropensci.org/pathviewr/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      indexName: "ropensci-pathviewr",
      pathsToMatch: ["https://docs.ropensci.org/pathviewr/index.html**/**"],
    ...
    {
      indexName: "ropensci-pathviewr",
      pathsToMatch: ["https://docs.ropensci.org/pathviewr/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "ropensci-pathviewr",
      pathsToMatch: ["https://docs.ropensci.org/pathviewr/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
