new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://docs.ropensci.org/nbaR/index.html",
    "https://docs.ropensci.org/",
    "https://docs.ropensci.org/nbaR/reference",
    "https://docs.ropensci.org/nbaR/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.ropensci.org/nbaR/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      ...
      pathsToMatch: ["https://docs.ropensci.org/nbaR/index.html**/**"],
    ...
    {
      indexName: "ropensci-nbar",
      pathsToMatch: ["https://docs.ropensci.org/nbaR/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "ropensci-nbar",
      pathsToMatch: ["https://docs.ropensci.org/nbaR/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
