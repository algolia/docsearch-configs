new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://docs.ropensci.org/refimpact/index.html",
    "https://docs.ropensci.org/",
    "https://docs.ropensci.org/refimpact/reference",
    "https://docs.ropensci.org/refimpact/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.ropensci.org/refimpact/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      ...
      pathsToMatch: ["https://docs.ropensci.org/refimpact/index.html**/**"],
    ...
    {
      indexName: "ropensci-refimpact",
      pathsToMatch: ["https://docs.ropensci.org/refimpact/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "ropensci-refimpact",
      pathsToMatch: ["https://docs.ropensci.org/refimpact/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
