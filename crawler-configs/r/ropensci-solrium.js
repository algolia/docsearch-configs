new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://docs.ropensci.org/solrium/index.html",
    "https://docs.ropensci.org/",
    "https://docs.ropensci.org/solrium/reference",
    "https://docs.ropensci.org/solrium/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.ropensci.org/solrium/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      ...
      pathsToMatch: ["https://docs.ropensci.org/solrium/index.html**/**"],
    ...
    {
      indexName: "ropensci-solrium",
      pathsToMatch: ["https://docs.ropensci.org/solrium/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "ropensci-solrium",
      pathsToMatch: ["https://docs.ropensci.org/solrium/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
