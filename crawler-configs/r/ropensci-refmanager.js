new Crawler({
  ...
  startUrls: [
    ...
    "https://docs.ropensci.org/RefManageR/reference",
    "https://docs.ropensci.org/RefManageR/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.ropensci.org/RefManageR/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      indexName: "ropensci-refmanager",
      pathsToMatch: ["https://docs.ropensci.org/RefManageR/index.html**/**"],
    ...
    {
      indexName: "ropensci-refmanager",
      pathsToMatch: ["https://docs.ropensci.org/RefManageR/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "ropensci-refmanager",
      pathsToMatch: ["https://docs.ropensci.org/RefManageR/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
