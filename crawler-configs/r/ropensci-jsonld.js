new Crawler({
  ...
  startUrls: [
    ...
    "https://docs.ropensci.org/jsonld/reference",
    "https://docs.ropensci.org/jsonld/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.ropensci.org/jsonld/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      indexName: "ropensci-jsonld",
      pathsToMatch: ["https://docs.ropensci.org/jsonld/index.html**/**"],
    ...
    {
      indexName: "ropensci-jsonld",
      pathsToMatch: ["https://docs.ropensci.org/jsonld/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "ropensci-jsonld",
      pathsToMatch: ["https://docs.ropensci.org/jsonld/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
