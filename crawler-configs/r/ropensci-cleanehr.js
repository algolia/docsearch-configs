new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://docs.ropensci.org/cleanEHR/index.html",
    "https://docs.ropensci.org/",
    "https://docs.ropensci.org/cleanEHR/reference",
    "https://docs.ropensci.org/cleanEHR/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.ropensci.org/cleanEHR/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      ...
      pathsToMatch: ["https://docs.ropensci.org/cleanEHR/index.html**/**"],
    ...
    {
      indexName: "ropensci-cleanehr",
      pathsToMatch: ["https://docs.ropensci.org/cleanEHR/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "ropensci-cleanehr",
      pathsToMatch: ["https://docs.ropensci.org/cleanEHR/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
