new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://docs.ropensci.org/CoordinateCleaner/index.html",
    "https://docs.ropensci.org/",
    "https://docs.ropensci.org/CoordinateCleaner/reference",
    "https://docs.ropensci.org/CoordinateCleaner/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.ropensci.org/lq/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      indexName: "ropensci-coordinatecleaner",
      pathsToMatch: [
        "https://docs.ropensci.org/CoordinateCleaner/index.html**/**",
      ],
