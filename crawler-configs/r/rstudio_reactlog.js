new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://rstudio.github.io/reactlog/index.html",
    "https://rstudio.github.io/",
    "https://rstudio.github.io/reactlog/reference",
    "https://rstudio.github.io/reactlog/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://rstudio.github.io/reactlog/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      ...
      pathsToMatch: ["https://rstudio.github.io/reactlog/index.html**/**"],
    ...
    {
      indexName: "rstudio_reactlog",
      pathsToMatch: ["https://rstudio.github.io/reactlog/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "rstudio_reactlog",
      pathsToMatch: ["https://rstudio.github.io/reactlog/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
