new Crawler({
  ...
  sitemaps: ["https://caravaggio.ramielcreations.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://caravaggio.ramielcreations.com/**"],
  schedule: "at 10:00 on Friday",
  actions: [
    {
      indexName: "ramielcreations_caravaggio",
      pathsToMatch: ["https://caravaggio.ramielcreations.com/docs/**"],
