new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://docs.ropensci.org/USAboundariesData/index.html",
    "https://docs.ropensci.org/",
    "https://docs.ropensci.org/USAboundariesData/reference",
    "https://docs.ropensci.org/USAboundariesData/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.ropensci.org/USAboundariesData/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      indexName: "ropensci-usaboundariesdata",
      pathsToMatch: [
        "https://docs.ropensci.org/USAboundariesData/index.html**/**",
      ],
