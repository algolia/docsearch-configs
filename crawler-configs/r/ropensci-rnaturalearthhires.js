new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://docs.ropensci.org/rnaturalearthhires/index.html",
    "https://docs.ropensci.org/",
    "https://docs.ropensci.org/rnaturalearthhires/reference",
    "https://docs.ropensci.org/rnaturalearthhires/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.ropensci.org/rnaturalearthhires/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      indexName: "ropensci-rnaturalearthhires",
      pathsToMatch: [
        "https://docs.ropensci.org/rnaturalearthhires/index.html**/**",
      ],
