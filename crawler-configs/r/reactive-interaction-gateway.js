new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://accenture.github.io/reactive-interaction-gateway/docs/",
    "https://accenture.github.io/",
  ],
  renderJavaScript: false,
  sitemaps: [
    "https://accenture.github.io/reactive-interaction-gateway/sitemap.xml",
  ],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://accenture.github.io/**"],
