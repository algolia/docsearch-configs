new Crawler({
  ...
  startUrls: [
    ...
    "https://docs.ropensci.org/writexl/reference",
    "https://docs.ropensci.org/writexl/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.ropensci.org/writexl/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      indexName: "ropensci-writexl",
      pathsToMatch: ["https://docs.ropensci.org/writexl/index.html**/**"],
    ...
    {
      indexName: "ropensci-writexl",
      pathsToMatch: ["https://docs.ropensci.org/writexl/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "ropensci-writexl",
      pathsToMatch: ["https://docs.ropensci.org/writexl/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
