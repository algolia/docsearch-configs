new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://docs.ropensci.org/webmockr/index.html",
    "https://docs.ropensci.org/",
    "https://docs.ropensci.org/webmockr/reference",
    "https://docs.ropensci.org/webmockr/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.ropensci.org/webmockr/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      indexName: "ropensci-webmockr",
      pathsToMatch: ["https://docs.ropensci.org/webmockr/index.html**/**"],
    ...
    {
      indexName: "ropensci-webmockr",
      pathsToMatch: ["https://docs.ropensci.org/webmockr/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "ropensci-webmockr",
      pathsToMatch: ["https://docs.ropensci.org/webmockr/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
