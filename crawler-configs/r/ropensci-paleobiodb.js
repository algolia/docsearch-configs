new Crawler({
  ...
  startUrls: [
    ...
    "https://docs.ropensci.org/paleobioDB/reference",
    "https://docs.ropensci.org/paleobioDB/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.ropensci.org/paleobioDB/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      indexName: "ropensci-paleobiodb",
      pathsToMatch: ["https://docs.ropensci.org/paleobioDB/index.html**/**"],
    ...
    {
      indexName: "ropensci-paleobiodb",
      pathsToMatch: ["https://docs.ropensci.org/paleobioDB/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "ropensci-paleobiodb",
      pathsToMatch: ["https://docs.ropensci.org/paleobioDB/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
