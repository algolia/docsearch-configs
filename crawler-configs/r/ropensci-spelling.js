new Crawler({
  ...
  startUrls: [
    ...
    "https://docs.ropensci.org/spelling/reference",
    "https://docs.ropensci.org/spelling/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.ropensci.org/spelling/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      indexName: "ropensci-spelling",
      pathsToMatch: ["https://docs.ropensci.org/spelling/index.html**/**"],
    ...
    {
      indexName: "ropensci-spelling",
      pathsToMatch: ["https://docs.ropensci.org/spelling/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "ropensci-spelling",
      pathsToMatch: ["https://docs.ropensci.org/spelling/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
