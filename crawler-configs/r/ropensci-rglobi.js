new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://docs.ropensci.org/rglobi/index.html",
    "https://docs.ropensci.org/",
    "https://docs.ropensci.org/rglobi/reference",
    "https://docs.ropensci.org/rglobi/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.ropensci.org/rglobi/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      indexName: "ropensci-rglobi",
      pathsToMatch: ["https://docs.ropensci.org/rglobi/index.html**/**"],
    ...
    {
      indexName: "ropensci-rglobi",
      pathsToMatch: ["https://docs.ropensci.org/rglobi/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "ropensci-rglobi",
      pathsToMatch: ["https://docs.ropensci.org/rglobi/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
