new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://docs.ropensci.org/allcontributors/index.html",
    "https://docs.ropensci.org/",
    "https://docs.ropensci.org/allcontributors/reference",
    "https://docs.ropensci.org/allcontributors/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.ropensci.org/allcontributors/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      indexName: "ropensci-allcontributors",
      pathsToMatch: [
        "https://docs.ropensci.org/allcontributors/index.html**/**",
      ],
    ...
    {
      indexName: "ropensci-allcontributors",
      pathsToMatch: ["https://docs.ropensci.org/allcontributors/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
