new Crawler({
  ...
  startUrls: [
    ...
    "https://docs.ropensci.org/microdemic/reference",
    "https://docs.ropensci.org/microdemic/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.ropensci.org/microdemic/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      indexName: "ropensci-microdemic",
      pathsToMatch: ["https://docs.ropensci.org/microdemic/index.html**/**"],
    ...
    {
      indexName: "ropensci-microdemic",
      pathsToMatch: ["https://docs.ropensci.org/microdemic/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "ropensci-microdemic",
      pathsToMatch: ["https://docs.ropensci.org/microdemic/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
