new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://docs.ropensci.org/googleLanguageR/index.html",
    "https://docs.ropensci.org/",
    "https://docs.ropensci.org/googleLanguageR/reference",
    "https://docs.ropensci.org/googleLanguageR/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.ropensci.org/googleLanguageR/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      indexName: "ropensci-googlelanguager",
      pathsToMatch: [
        "https://docs.ropensci.org/googleLanguageR/index.html**/**",
      ],
    ...
    {
      indexName: "ropensci-googlelanguager",
      pathsToMatch: ["https://docs.ropensci.org/googleLanguageR/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
