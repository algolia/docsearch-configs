new Crawler({
  ...
  startUrls: [
    ...
    "https://docs.ropensci.org/patentsview/reference",
    "https://docs.ropensci.org/patentsview/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.ropensci.org/patentsview/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      indexName: "ropensci-patentsview",
      pathsToMatch: ["https://docs.ropensci.org/patentsview/index.html**/**"],
    ...
    {
      indexName: "ropensci-patentsview",
      pathsToMatch: ["https://docs.ropensci.org/patentsview/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "ropensci-patentsview",
      pathsToMatch: ["https://docs.ropensci.org/patentsview/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
