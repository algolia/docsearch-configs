new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://docs.ropensci.org/citesdb/index.html",
    "https://docs.ropensci.org/",
    "https://docs.ropensci.org/citesdb/reference",
    "https://docs.ropensci.org/citesdb/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.ropensci.org/citesdb/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      ...
      pathsToMatch: ["https://docs.ropensci.org/citesdb/index.html**/**"],
    ...
    {
      indexName: "ropensci-citesdb",
      pathsToMatch: ["https://docs.ropensci.org/citesdb/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "ropensci-citesdb",
      pathsToMatch: ["https://docs.ropensci.org/citesdb/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
