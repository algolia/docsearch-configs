new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://docs.ropensci.org/opentripplanner/index.html",
    "https://docs.ropensci.org/",
    "https://docs.ropensci.org/opentripplanner/reference",
    "https://docs.ropensci.org/opentripplanner/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.ropensci.org/opentripplanner/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      indexName: "ropensci-opentripplanner",
      pathsToMatch: [
        "https://docs.ropensci.org/opentripplanner/index.html**/**",
      ],
    ...
    {
      indexName: "ropensci-opentripplanner",
      pathsToMatch: ["https://docs.ropensci.org/opentripplanner/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
