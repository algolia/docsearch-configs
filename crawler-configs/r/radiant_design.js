new Crawler({
  ...
  startUrls: [
    ...
    "https://radiant-rstats.github.io/",
  ],
  renderJavaScript: false,
  sitemaps: [],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://radiant-rstats.github.io/**"],
  schedule: "at 10:00 on Friday",
  actions: [
    {
      indexName: "radiant_design",
      pathsToMatch: ["https://radiant-rstats.github.io/radiant.design/**"],
