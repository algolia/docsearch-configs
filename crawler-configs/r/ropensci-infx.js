new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://docs.ropensci.org/infx/index.html",
    "https://docs.ropensci.org/",
    "https://docs.ropensci.org/infx/reference",
    "https://docs.ropensci.org/infx/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.ropensci.org/infx/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      ...
      pathsToMatch: ["https://docs.ropensci.org/infx/index.html**/**"],
    ...
    {
      indexName: "ropensci-infx",
      pathsToMatch: ["https://docs.ropensci.org/infx/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "ropensci-infx",
      pathsToMatch: ["https://docs.ropensci.org/infx/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
