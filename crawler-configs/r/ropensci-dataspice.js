new Crawler({
  ...
  startUrls: [
    ...
    "https://docs.ropensci.org/dataspice/reference",
    "https://docs.ropensci.org/dataspice/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.ropensci.org/dataspice/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      indexName: "ropensci-dataspice",
      pathsToMatch: ["https://docs.ropensci.org/dataspice/index.html**/**"],
    ...
    {
      indexName: "ropensci-dataspice",
      pathsToMatch: ["https://docs.ropensci.org/dataspice/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "ropensci-dataspice",
      pathsToMatch: ["https://docs.ropensci.org/dataspice/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
