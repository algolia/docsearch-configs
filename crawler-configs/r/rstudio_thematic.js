new Crawler({
  ...
  startUrls: [
    ...
    "https://rstudio.github.io/thematic/reference",
    "https://rstudio.github.io/thematic/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://rstudio.github.io/thematic/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      ...
      pathsToMatch: ["https://rstudio.github.io/thematic/index.html**/**"],
    ...
    {
      indexName: "rstudio_thematic",
      pathsToMatch: ["https://rstudio.github.io/thematic/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "rstudio_thematic",
      pathsToMatch: ["https://rstudio.github.io/thematic/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
