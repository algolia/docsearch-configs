new Crawler({
  ...
  startUrls: [
    ...
    "https://docs.ropensci.org/rtweet/reference",
    "https://docs.ropensci.org/rtweet/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.ropensci.org/rtweet/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      indexName: "ropensci-rtweet",
      pathsToMatch: ["https://docs.ropensci.org/rtweet/index.html**/**"],
    ...
    {
      indexName: "ropensci-rtweet",
      pathsToMatch: ["https://docs.ropensci.org/rtweet/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "ropensci-rtweet",
      pathsToMatch: ["https://docs.ropensci.org/rtweet/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
