new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://docs.ropensci.org/internetarchive/index.html",
    "https://docs.ropensci.org/",
    "https://docs.ropensci.org/internetarchive/reference",
    "https://docs.ropensci.org/internetarchive/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.ropensci.org/internetarchive/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      indexName: "ropensci-internetarchive",
      pathsToMatch: [
        "https://docs.ropensci.org/internetarchive/index.html**/**",
      ],
    ...
    {
      indexName: "ropensci-internetarchive",
      pathsToMatch: ["https://docs.ropensci.org/internetarchive/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
