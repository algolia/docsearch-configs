new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://docs.ropensci.org/dbhydroR/index.html",
    "https://docs.ropensci.org/",
    "https://docs.ropensci.org/dbhydroR/reference",
    "https://docs.ropensci.org/dbhydroR/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.ropensci.org/dbhydroR/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      ...
      pathsToMatch: ["https://docs.ropensci.org/dbhydroR/index.html**/**"],
    ...
    {
      indexName: "ropensci-dbhydror",
      pathsToMatch: ["https://docs.ropensci.org/dbhydroR/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "ropensci-dbhydror",
      pathsToMatch: ["https://docs.ropensci.org/dbhydroR/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
