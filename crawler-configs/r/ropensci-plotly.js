new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://docs.ropensci.org/plotly/index.html",
    "https://docs.ropensci.org/",
    "https://docs.ropensci.org/plotly/reference",
    "https://docs.ropensci.org/plotly/articles",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.ropensci.org/plotly/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      ...
      pathsToMatch: ["https://docs.ropensci.org/plotly/index.html**/**"],
    ...
    {
      indexName: "ropensci-plotly",
      pathsToMatch: ["https://docs.ropensci.org/plotly/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "ropensci-plotly",
      pathsToMatch: ["https://docs.ropensci.org/plotly/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
