new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://resources.agiledrop.com/docs/",
    "https://resources.agiledrop.com/",
    "https://resources.agiledrop.com/docs/drupal/db_stuff/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://resources.agiledrop.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://resources.agiledrop.com/**"],
