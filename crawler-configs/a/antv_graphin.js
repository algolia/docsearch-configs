new Crawler({
  ...
  discoveryPatterns: ["https://graphin.antv.vision/**"],
  schedule: "at 01:30 on Tuesday",
  actions: [
    {
      indexName: "antv_graphin",
      pathsToMatch: ["https://graphin.antv.vision/zh**/**"],
    ...
    {
      indexName: "antv_graphin",
      pathsToMatch: ["https://graphin.antv.vision/en**/**"],
      recordExtractor: ({ $, helpers }) => {
        return helpers.docsearch({
          recordProps: {
            lvl1: "article h1, .banner-title",
