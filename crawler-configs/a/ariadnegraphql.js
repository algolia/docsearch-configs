new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://ariadnegraphql.org/docs/",
    "https://ariadnegraphql.org/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://ariadnegraphql.org/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://ariadnegraphql.org/**"],
  schedule: "at 01:40 on Tuesday",
  actions: [
    {
      indexName: "ariadnegraphql",
      pathsToMatch: ["https://ariadnegraphql.org/docs/**"],
