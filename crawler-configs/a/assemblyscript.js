new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://www.assemblyscript.org/"],
  renderJavaScript: false,
  sitemaps: ["https://www.assemblyscript.org/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://www.assemblyscript.org/**"],
  schedule: "at 01:40 on Tuesday",
  actions: [
    {
      indexName: "assemblyscript",
      pathsToMatch: ["https://www.assemblyscript.org/**"],
