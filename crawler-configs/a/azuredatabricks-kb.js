new Crawler({
  ...
  sitemaps: [
    "https://docs.microsoft.com/en-us/azure/databricks/kb/sitemap.xml",
  ],
  ...
  actions: [
    {
      indexName: "azuredatabricks-kb",
      pathsToMatch: ["https://docs.microsoft.com/en-us/azure/databricks/kb/**"],
