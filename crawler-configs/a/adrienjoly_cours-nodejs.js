new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["http://adrienjoly.com/cours-nodejs/", "http://adrienjoly.com/"],
  ...
  actions: [
    {
      indexName: "adrienjoly_cours-nodejs",
      pathsToMatch: ["http://adrienjoly.com/cours-nodejs/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".markdown-body h1 a";
        $(toRemove).remove();
