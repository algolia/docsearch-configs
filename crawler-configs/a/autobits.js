new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://docs.autobits.org/"],
  renderJavaScript: false,
  sitemaps: ["https://docs.autobits.org/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.autobits.org/**"],
  schedule: "at 01:40 on Tuesday",
  actions: [
    {
      indexName: "autobits",
      pathsToMatch: ["https://docs.autobits.org/**"],
