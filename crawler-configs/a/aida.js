new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://sradevski.com/aida/docs/",
    "https://sradevski.com/",
    "https://sradevski.com/aida/docs/getting-started/introduction.html",
  ],
  renderJavaScript: false,
  sitemaps: ["https://sradevski.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://sradevski.com/**"],
