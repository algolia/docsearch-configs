new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://help.aula.bg/docs/", "https://help.aula.bg/"],
  renderJavaScript: false,
  sitemaps: ["https://help.aula.bg/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://help.aula.bg/**"],
  schedule: "at 01:40 on Tuesday",
  actions: [
    {
      indexName: "aula_help",
      pathsToMatch: ["https://help.aula.bg/docs/**"],
