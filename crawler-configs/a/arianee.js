new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://docs.arianee.org/docs/",
    "https://docs.arianee.org/",
    "https://docs.arianee.org/docs/intro",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.arianee.org/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.arianee.org/**"],
