new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://motion-layout.azurewebsites.net/docs/",
    "https://motion-layout.azurewebsites.net/",
    "https://motion-layout.azurewebsites.net/docs/installation",
  ],
  renderJavaScript: false,
  sitemaps: ["https://motion-layout.azurewebsites.net/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://motion-layout.azurewebsites.net/**"],
