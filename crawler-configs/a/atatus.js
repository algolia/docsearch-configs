new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://docs.atatus.com/"],
  renderJavaScript: false,
  sitemaps: ["https://docs.atatus.com/docs/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.atatus.com/**"],
  schedule: "at 01:40 on Tuesday",
  actions: [
    {
      indexName: "atatus",
      pathsToMatch: ["https://docs.atatus.com/**"],
