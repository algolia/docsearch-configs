new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://sdk.apify.com/docs/", "https://sdk.apify.com/"],
  renderJavaScript: false,
  sitemaps: ["https://sdk.apify.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://sdk.apify.com/**"],
  schedule: "at 01:30 on Tuesday",
  actions: [
    {
      indexName: "apify_sdk",
      pathsToMatch: ["https://sdk.apify.com/docs/**"],
