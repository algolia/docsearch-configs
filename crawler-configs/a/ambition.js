new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://hui.ambition.works/"],
  renderJavaScript: false,
  sitemaps: ["https://hui.ambition.works/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://hui.ambition.works/**"],
  schedule: "at 01:20 on Tuesday",
  actions: [
    {
      indexName: "ambition",
      pathsToMatch: ["https://hui.ambition.works/**"],
