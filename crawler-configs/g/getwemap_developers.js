new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://developers.getwemap.com/docs/",
    "https://developers.getwemap.com/",
    "https://developers.getwemap.com/docs/getting-started",
  ],
  renderJavaScript: false,
  sitemaps: ["https://developers.getwemap.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://developers.getwemap.com/**"],
  schedule: "at 06:00 on Wednesday",
  actions: [
    {
      indexName: "getwemap_developers",
      pathsToMatch: [
        "https://developers.getwemap.com/docs/**",
        "https://developers.getwemap.com/docs/getting-started**/**",
      ],
