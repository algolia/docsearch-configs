new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://edata.gtdreamlife.com/doc/",
    "https://edata.gtdreamlife.com/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://edata.gtdreamlife.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://edata.gtdreamlife.com/**"],
  schedule: "at 06:40 on Wednesday",
  actions: [
    {
      indexName: "gtdreamlife_edata",
      pathsToMatch: ["https://edata.gtdreamlife.com/doc/**"],
