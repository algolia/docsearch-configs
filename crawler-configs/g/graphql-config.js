new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://graphql-config.com/"],
  renderJavaScript: false,
  sitemaps: ["https://graphql-config.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://graphql-config.com/**"],
  schedule: "at 06:40 on Wednesday",
  actions: [
    {
      indexName: "graphql-config",
      pathsToMatch: ["https://graphql-config.com/**"],
