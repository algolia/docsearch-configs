new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["http://s.gooin.win/docs/", "http://s.gooin.win/"],
  renderJavaScript: false,
  sitemaps: ["http://s.gooin.win/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["http://s.gooin.win/**"],
  schedule: "at 06:30 on Wednesday",
  actions: [
    {
      indexName: "gooin_s",
      pathsToMatch: ["http://s.gooin.win/docs/**"],
