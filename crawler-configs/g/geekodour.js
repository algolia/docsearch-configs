new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://wiki.geekodour.xyz/docs/",
    "https://wiki.geekodour.xyz/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://wiki.geekodour.xyz/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://wiki.geekodour.xyz/**"],
  schedule: "at 06:00 on Wednesday",
  actions: [
    {
      indexName: "geekodour",
      pathsToMatch: ["https://wiki.geekodour.xyz/docs/**"],
