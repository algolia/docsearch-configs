new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://glardocs.glartek.workers.dev/docs/",
    "https://glardocs.glartek.workers.dev/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://glardocs.glartek.workers.dev/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://glardocs.glartek.workers.dev/**"],
  schedule: "at 06:20 on Wednesday",
  actions: [
    {
      indexName: "glartek",
      pathsToMatch: ["https://glardocs.glartek.workers.dev/docs/**"],
