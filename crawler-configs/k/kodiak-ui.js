new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://kodiak-ui.com/", "https://kodiak-ui.com/introduction"],
  renderJavaScript: false,
  sitemaps: ["https://kodiak-ui.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://kodiak-ui.com/**"],
  ...
  actions: [
    {
      ...
      pathsToMatch: [
        "https://kodiak-ui.com/**",
        "https://kodiak-ui.com/introduction**/**",
      ],
