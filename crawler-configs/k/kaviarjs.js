new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://www.kaviarjs.com/docs/", "https://www.kaviarjs.com/"],
  renderJavaScript: false,
  sitemaps: ["https://www.kaviarjs.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://www.kaviarjs.com/**"],
  schedule: "at 01:00 on Thursday",
  actions: [
    {
      indexName: "kaviarjs",
      pathsToMatch: ["https://www.kaviarjs.com/docs/**"],
