new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://docs.kwickmetrics.com/docs/",
    "https://docs.kwickmetrics.com/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.kwickmetrics.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.kwickmetrics.com/**"],
  schedule: "at 01:50 on Thursday",
  actions: [
    {
      indexName: "kwickmetrics",
      pathsToMatch: ["https://docs.kwickmetrics.com/docs/**"],
