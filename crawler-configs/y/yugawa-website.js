new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://yugawa.xyz/docs/", "https://yugawa.xyz/"],
  renderJavaScript: false,
  sitemaps: ["https://yugawa.xyz/docs/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://yugawa.xyz/**"],
  schedule: "at 19:40 on Saturday",
  actions: [
    {
      indexName: "yugawa-website",
      pathsToMatch: ["https://yugawa.xyz/docs/**"],
