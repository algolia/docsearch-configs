new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://yew.rs/docs/", "https://yew.rs/"],
  renderJavaScript: false,
  sitemaps: ["https://yew.rs/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://yew.rs/**"],
  schedule: "at 19:00 on Saturday",
  actions: [
    {
      indexName: "yew",
      pathsToMatch: ["https://yew.rs/docs/**"],
      recordExtractor: ({ $, helpers }) => {
        return helpers.docsearch({
          recordProps: {
            lvl1: "[class*='--pageContainer-'] h2",
            content:
              "[class*='--pageContainer-'] p, [class*='--pageContainer-'] li",
            lvl0: {
