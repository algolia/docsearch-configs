new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "http://icu.youcanstar.com/docs/",
    "http://icu.youcanstar.com/",
    "http://icu.youcanstar.com/docs/doc1",
  ],
  renderJavaScript: false,
  sitemaps: ["http://icu.youcanstar.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["http://icu.youcanstar.com/**"],
  schedule: "at 19:30 on Saturday",
  actions: [
    {
      indexName: "youcanstar_icu",
      pathsToMatch: [
        "http://icu.youcanstar.com/docs/**",
        "http://icu.youcanstar.com/docs/doc1**/**",
      ],
