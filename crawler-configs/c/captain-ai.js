new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://captain-ai-docs.netlify.app/docs/",
    "https://captain-ai-docs.netlify.app/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://captain-ai-docs.netlify.app/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://captain-ai-docs.netlify.app/**"],
  schedule: "at 11:00 on Tuesday",
  actions: [
    {
      indexName: "captain-ai",
      pathsToMatch: ["https://captain-ai-docs.netlify.app/docs/**"],
