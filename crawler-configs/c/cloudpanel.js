new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://www.cloudpanel.io/docs/", "https://www.cloudpanel.io/"],
  renderJavaScript: false,
  sitemaps: ["https://www.cloudpanel.io/docs/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://www.cloudpanel.io/**"],
  schedule: "at 11:20 on Tuesday",
  actions: [
    {
      indexName: "cloudpanel",
      pathsToMatch: ["https://www.cloudpanel.io/docs/**"],
