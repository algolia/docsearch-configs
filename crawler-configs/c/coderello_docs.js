new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://coderello.com/"],
  renderJavaScript: true,
  sitemaps: ["https://coderello.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://coderello.com/**"],
  schedule: "at 11:30 on Tuesday",
  actions: [
    {
      indexName: "coderello_docs",
      pathsToMatch: ["https://coderello.com**/**"],
