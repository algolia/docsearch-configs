new Crawler({
  ...
  startUrls: [
    ...
    "https://uncg-daisy.github.io/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://uncg-daisy.github.io/Coastal-Image-Labeler/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://uncg-daisy.github.io/**"],
  schedule: "at 11:30 on Tuesday",
  actions: [
    {
      indexName: "coastal-image-labeler",
      pathsToMatch: ["https://uncg-daisy.github.io/Coastal-Image-Labeler/**"],
