new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://cognitivescale.github.io/cortex-charts/",
    "https://cognitivescale.github.io/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://cognitivescale.github.io/cortex-charts/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://cognitivescale.github.io/**"],
  schedule: "at 11:30 on Tuesday",
  actions: [
    {
      indexName: "cortex",
      pathsToMatch: ["https://cognitivescale.github.io/cortex-charts/**"],
