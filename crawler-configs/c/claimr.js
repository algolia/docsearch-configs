new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://docs.claimr.tools/docs/", "https://docs.claimr.tools/"],
  renderJavaScript: false,
  sitemaps: ["https://docs.claimr.tools/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.claimr.tools/**"],
  schedule: "at 11:20 on Tuesday",
  actions: [
    {
      indexName: "claimr",
      pathsToMatch: ["https://docs.claimr.tools/docs/**"],
