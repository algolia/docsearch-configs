new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "http://colossal1.cactusthemes.com/doc/",
    "http://colossal1.cactusthemes.com/",
  ],
  renderJavaScript: true,
  sitemaps: [],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["http://colossal1.cactusthemes.com/**"],
  schedule: "at 11:30 on Tuesday",
  actions: [
    {
      indexName: "colossal1",
      pathsToMatch: ["http://colossal1.cactusthemes.com/doc/**"],
