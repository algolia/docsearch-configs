new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["http://cosi166r.s3-website-us-east-1.amazonaws.com/"],
  renderJavaScript: false,
  sitemaps: [],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["http://cosi166r.s3-website-us-east-1.amazonaws.com/**"],
  schedule: "at 11:30 on Tuesday",
  actions: [
    {
      indexName: "cosi166r",
      pathsToMatch: ["http://cosi166r.s3-website-us-east-1.amazonaws.com**/**"],
