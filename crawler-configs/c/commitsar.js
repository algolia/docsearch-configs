new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://commitsar.tech/docs/", "https://commitsar.tech/"],
  renderJavaScript: false,
  sitemaps: ["https://commitsar.tech/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://commitsar.tech/**"],
  schedule: "at 11:30 on Tuesday",
  actions: [
    {
      indexName: "commitsar",
      pathsToMatch: ["https://commitsar.tech/docs/**"],
