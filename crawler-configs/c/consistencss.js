new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://consistencss.now.sh/docs/",
    "https://consistencss.now.sh/",
    "https://consistencss.now.sh/docs/getting-started",
  ],
  renderJavaScript: false,
  sitemaps: ["https://consistencss.now.sh/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://consistencss.now.sh/**"],
