new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://payments.collectorbank.se/"],
  renderJavaScript: false,
  sitemaps: ["https://payments.collectorbank.se/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://payments.collectorbank.se/**"],
  schedule: "at 11:30 on Tuesday",
  actions: [
    {
      indexName: "collectorbank_payments",
      pathsToMatch: ["https://payments.collectorbank.se/**"],
