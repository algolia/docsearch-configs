new Crawler({
  ...
  actions: [
    ...
    {
      indexName: "centreon",
      pathsToMatch: ["https://docs.centreon.com/21.04/fr/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".hash-link";
        $(toRemove).remove();
    ...
    {
      indexName: "centreon",
      pathsToMatch: ["https://docs.centreon.com/20.10/en/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".hash-link";
        $(toRemove).remove();
    ...
    {
      indexName: "centreon",
      pathsToMatch: ["https://docs.centreon.com/20.10/fr/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".hash-link";
        $(toRemove).remove();
    ...
    {
      indexName: "centreon",
      pathsToMatch: ["https://docs.centreon.com/20.04/en/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".hash-link";
        $(toRemove).remove();
    ...
    {
      indexName: "centreon",
      pathsToMatch: ["https://docs.centreon.com/20.04/fr/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".hash-link";
        $(toRemove).remove();
