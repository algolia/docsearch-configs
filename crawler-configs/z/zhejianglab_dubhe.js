new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["http://docs.dubhe.ai/docs/", "http://docs.dubhe.ai/"],
  renderJavaScript: false,
  sitemaps: ["http://docs.dubhe.ai/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["http://docs.dubhe.ai/**"],
  schedule: "at 00:10 on Sunday",
  actions: [
    {
      indexName: "zhejianglab_dubhe",
      pathsToMatch: ["http://docs.dubhe.ai/docs/**"],
