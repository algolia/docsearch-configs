new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://dev.zilliqa.com/docs/", "https://dev.zilliqa.com/"],
  renderJavaScript: false,
  sitemaps: ["https://dev.zilliqa.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://dev.zilliqa.com/**"],
  schedule: "at 00:10 on Sunday",
  actions: [
    {
      indexName: "zilliqa_developer",
      pathsToMatch: ["https://dev.zilliqa.com/docs/**"],
