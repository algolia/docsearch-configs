new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://shopify.livingcolor.academy/docs/",
    "https://shopify.livingcolor.academy/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://shopify.livingcolor.academy/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://shopify.livingcolor.academy/**"],
  schedule: "at 15:10 on Friday",
  actions: [
    {
      indexName: "shopify_livingcolor_academy",
      pathsToMatch: ["https://shopify.livingcolor.academy/docs/**"],
