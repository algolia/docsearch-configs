new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://socketcluster.io/docs/", "https://socketcluster.io/"],
  renderJavaScript: false,
  sitemaps: ["https://socketcluster.io/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://socketcluster.io/**"],
  schedule: "at 15:30 on Friday",
  actions: [
    {
      indexName: "socketcluster",
      pathsToMatch: ["https://socketcluster.io/docs/**"],
