new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://spothero.com/uniform/ace/docs/",
    "https://spothero.com/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://spothero.com/uniform/ace/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://spothero.com/**"],
  schedule: "at 15:30 on Friday",
  actions: [
    {
      indexName: "spothero_ace",
      pathsToMatch: ["https://spothero.com/uniform/ace/docs/**"],
