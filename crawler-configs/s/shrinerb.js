new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://shrinerb.com/docs/", "https://shrinerb.com/"],
  renderJavaScript: false,
  sitemaps: ["https://shrinerb.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://shrinerb.com/**"],
  schedule: "at 15:10 on Friday",
  actions: [
    {
      indexName: "shrinerb",
      pathsToMatch: ["https://shrinerb.com/docs/**"],
