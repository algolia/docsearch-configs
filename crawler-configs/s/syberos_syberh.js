new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://syberh.syberos.com/docs/",
    "https://syberh.syberos.com/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://syberh.syberos.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://syberh.syberos.com/**"],
  schedule: "at 15:50 on Friday",
  actions: [
    {
      indexName: "syberos_syberh",
      pathsToMatch: ["https://syberh.syberos.com/docs/**"],
