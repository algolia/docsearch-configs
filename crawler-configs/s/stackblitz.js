new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://developer.stackblitz.com/docs/",
    "https://developer.stackblitz.com/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://developer.stackblitz.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://developer.stackblitz.com/**"],
  schedule: "at 15:40 on Friday",
  actions: [
    {
      indexName: "stackblitz",
      pathsToMatch: ["https://developer.stackblitz.com/docs/**"],
