new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://stethoscope.js.org/docs/",
    "https://stethoscope.js.org/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://stethoscope.js.org/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://stethoscope.js.org/**"],
  schedule: "at 15:40 on Friday",
  actions: [
    {
      indexName: "stethoscope",
      pathsToMatch: ["https://stethoscope.js.org/docs/**"],
