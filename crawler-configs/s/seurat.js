new Crawler({
  ...
  sitemaps: ["https://satijalab.org/sitemap.xml"],
  exclusionPatterns: [
    "**/reference/",
  ...
  actions: [
    {
      indexName: "seurat",
      pathsToMatch: ["https://satijalab.org/seurat/index.html**/**"],
    ...
    {
      indexName: "seurat",
      pathsToMatch: ["https://satijalab.org/seurat/reference**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
    ...
    {
      indexName: "seurat",
      pathsToMatch: ["https://satijalab.org/seurat/articles**/**"],
      recordExtractor: ({ $, helpers }) => {
        // Removing DOM elements we don't want to crawl
        const toRemove = ".dont-index";
        $(toRemove).remove();
