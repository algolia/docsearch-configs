new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://steamspeak.netlify.app/"],
  renderJavaScript: false,
  sitemaps: ["https://steamspeak.netlify.app/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://steamspeak.netlify.app/**"],
  schedule: "at 15:40 on Friday",
  actions: [
    {
      indexName: "steamspeak",
      pathsToMatch: ["https://steamspeak.netlify.app/**"],
