new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://beta.developer.signicat.com/"],
  renderJavaScript: false,
  sitemaps: [],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://beta.developer.signicat.com/**"],
  schedule: "at 15:10 on Friday",
  actions: [
    {
      indexName: "signicat_entreprise",
      pathsToMatch: ["https://beta.developer.signicat.com/**"],
