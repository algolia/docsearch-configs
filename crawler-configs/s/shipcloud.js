new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://developers.shipcloud.io/"],
  renderJavaScript: false,
  sitemaps: ["https://developers.shipcloud.io/sitemap.xml"],
  exclusionPatterns: ["**/schemas/**", "**/reference/**"],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://developers.shipcloud.io/**"],
  schedule: "at 15:10 on Friday",
  actions: [
    {
      indexName: "shipcloud",
      pathsToMatch: ["https://developers.shipcloud.io**/**"],
