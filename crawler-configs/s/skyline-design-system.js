new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://skyline.benevity.org/"],
  renderJavaScript: false,
  sitemaps: [],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://skyline.benevity.org/**"],
  schedule: "at 15:20 on Friday",
  actions: [
    {
      indexName: "skyline-design-system",
      pathsToMatch: ["https://skyline.benevity.org/**"],
