new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://www.solucgi.com/support/docs/",
    "https://www.solucgi.com/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://www.solucgi.com/support/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://www.solucgi.com/**"],
  schedule: "at 15:30 on Friday",
  actions: [
    {
      indexName: "solucgi",
      pathsToMatch: ["https://www.solucgi.com/support/docs/**"],
