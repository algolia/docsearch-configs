new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://syncstack.github.io/docs/",
    "https://syncstack.github.io/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://syncstack.github.io/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://syncstack.github.io/**"],
  schedule: "at 15:50 on Friday",
  actions: [
    {
      indexName: "syncstack",
      pathsToMatch: ["https://syncstack.github.io/docs/**"],
