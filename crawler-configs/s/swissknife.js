new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://docs.swissknife.dev/docs/",
    "https://docs.swissknife.dev/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://docs.swissknife.dev/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.swissknife.dev/**"],
  schedule: "at 15:50 on Friday",
  actions: [
    {
      indexName: "swissknife",
      pathsToMatch: ["https://docs.swissknife.dev/docs/**"],
