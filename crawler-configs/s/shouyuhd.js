new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "http://docs.shouyuhd.com/docs/",
    "http://docs.shouyuhd.com/",
    "http://docs.shouyuhd.com/docs/home",
  ],
  renderJavaScript: false,
  sitemaps: ["http://docs.shouyuhd.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["http://docs.shouyuhd.com/**"],
