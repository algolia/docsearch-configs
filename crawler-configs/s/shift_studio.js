new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://docs.shift.studio/docs/", "https://docs.shift.studio/"],
  renderJavaScript: false,
  sitemaps: ["https://docs.shift.studio/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.shift.studio/**"],
  schedule: "at 15:10 on Friday",
  actions: [
    {
      indexName: "shift_studio",
      pathsToMatch: ["https://docs.shift.studio/docs/**"],
