new Crawler({
  ...
  startUrls: [
    ...
    "https://www.native-testing-library.com/docs/next/intro",
  ],
  renderJavaScript: false,
  sitemaps: ["https://www.native-testing-library.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://www.native-testing-library.com/**"],
  ...
  initialIndexSettings: {
    "bcarroll22-native-testing-library": {
