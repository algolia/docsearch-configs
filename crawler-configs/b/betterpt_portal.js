new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://portal.betterpt.dev/docs/",
    "https://portal.betterpt.dev/",
    "https://portal.betterpt.dev/docs/welcome",
  ],
  renderJavaScript: false,
  sitemaps: ["https://portal.betterpt.dev/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://portal.betterpt.dev/**"],
  schedule: "at 06:00 on Tuesday",
  actions: [
    {
      indexName: "betterpt_portal",
      pathsToMatch: [
        "https://portal.betterpt.dev/docs/**",
        "https://portal.betterpt.dev/docs/welcome**/**",
      ],
