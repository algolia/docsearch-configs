new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://bigin-fe-guides.netlify.app/"],
  renderJavaScript: false,
  sitemaps: [],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://bigin-fe-guides.netlify.app/**"],
  schedule: "at 06:10 on Tuesday",
  actions: [
    {
      indexName: "bigin-fe",
      pathsToMatch: ["https://bigin-fe-guides.netlify.app/**"],
