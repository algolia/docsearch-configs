new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://www.balena.io/docs", "https://www.balena.io/"],
  renderJavaScript: false,
  sitemaps: [],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://www.balena.io/**"],
  schedule: "at 06:00 on Tuesday",
  actions: [
    {
      indexName: "balena",
      pathsToMatch: ["https://www.balena.io/docs**/**"],
      recordExtractor: ({ $, helpers }) => {
        ...
        return helpers.docsearch({
          recordProps: {
            ...
            lvl0: {
              selectors: ".site-navigation .nav-tabs li.active",
            },
