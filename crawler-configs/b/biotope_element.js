new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://element.biotope.sh/docs/",
    "https://element.biotope.sh/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://element.biotope.sh/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://element.biotope.sh/**"],
  schedule: "at 06:10 on Tuesday",
  actions: [
    {
      indexName: "biotope_element",
      pathsToMatch: ["https://element.biotope.sh/docs/**"],
