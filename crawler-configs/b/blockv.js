new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://developer.blockv.io/docs",
    "https://developer.blockv.io/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://developer.blockv.io/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://developer.blockv.io/**"],
  schedule: "at 06:20 on Tuesday",
  actions: [
    {
      indexName: "blockv",
      pathsToMatch: ["https://developer.blockv.io/docs**/**"],
