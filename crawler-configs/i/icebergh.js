new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://docs.icebergh.io/"],
  renderJavaScript: false,
  sitemaps: ["https://docs.icebergh.io/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://docs.icebergh.io/**"],
  schedule: "at 15:00 on Wednesday",
  actions: [
    {
      indexName: "icebergh",
      pathsToMatch: ["https://docs.icebergh.io/**"],
