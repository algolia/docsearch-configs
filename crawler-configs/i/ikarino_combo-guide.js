new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://combo-guide.now.sh/docs/",
    "https://combo-guide.now.sh/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://combo-guide.now.sh/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://combo-guide.now.sh/**"],
  schedule: "at 15:20 on Wednesday",
  actions: [
    {
      indexName: "ikarino_combo-guide",
      pathsToMatch: ["https://combo-guide.now.sh/docs/**"],
