new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://inivation.gitlab.io/dv/dv-docs/docs/",
    "https://inivation.gitlab.io/",
    "https://inivation.gitlab.io/dv/dv-docs/docs/getting-started/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://inivation.gitlab.io/dv/dv-docs/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://inivation.gitlab.io/**"],
  schedule: "at 15:30 on Wednesday",
  actions: [
    {
      indexName: "inivation_dv",
      pathsToMatch: [
        "https://inivation.gitlab.io/dv/dv-docs/docs/**",
        "https://inivation.gitlab.io/dv/dv-docs/docs/getting-started/**",
      ],
