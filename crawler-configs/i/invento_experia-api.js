new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://experia-on-premises.invento.sa/docs/",
    "https://experia-on-premises.invento.sa/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://experia-on-premises.invento.sa/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://experia-on-premises.invento.sa/**"],
  schedule: "at 15:30 on Wednesday",
  actions: [
    {
      indexName: "invento_experia-api",
      pathsToMatch: ["https://experia-on-premises.invento.sa/docs/**"],
