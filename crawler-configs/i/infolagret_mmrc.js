new Crawler({
  ...
  rateLimit: 8,
  startUrls: [
    "https://www.infolagret.se/mmrc/docs/",
    "https://www.infolagret.se/",
  ],
  renderJavaScript: false,
  sitemaps: ["https://www.infolagret.se/mmrc/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://www.infolagret.se/**"],
  schedule: "at 15:30 on Wednesday",
  actions: [
    {
      indexName: "infolagret_mmrc",
      pathsToMatch: ["https://www.infolagret.se/mmrc/docs/**"],
