new Crawler({
  ...
  apiKey: "",
  rateLimit: 8,
  startUrls: ["https://install.disism.com/"],
  renderJavaScript: false,
  sitemaps: ["https://install.disism.com/sitemap.xml"],
  exclusionPatterns: [],
  ignoreCanonicalTo: false,
  discoveryPatterns: ["https://install.disism.com/**"],
  schedule: "at 15:30 on Wednesday",
  actions: [
    {
      indexName: "install-disism",
      pathsToMatch: ["https://install.disism.com/**"],
